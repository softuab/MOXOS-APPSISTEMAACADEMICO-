...
var currentDayFontColor = "#ff0033";  //"#ffffff"; //colordela fechaescogida
    ...
    for (var i = 0; i < 6; i++) {
        ...
        for (var j = weekDay; j < weekDay + 7; j++) {
            if (i * 7 + j < fd || dayCount > ld) {
                ...
                s += "<td onmouseover=this.style.background='" + color1 + "'  onmouseout=this.style.background='" + color2 + "' onclick='javascript: if (window.opener && !window.opener.closed && window.opener.pickDate) window.opener.pickDate(" + dayCount + ")'>" + span1(fgTag) + (dayCount++) + span2 + "</td>";
            }
        }
        s += "</tr>";
    }
...
function validar(obj, tipo) {
    ...
    if (obj.value == "") {
        ...
        switch (tipo) {
            ...
            case 'A' :
                for (i = 0; i < cad.length; i++) {
                    if (!((cad[i] == ' ') || ((cad[i] >= 'a') && (cad[i] <= 'z')) || ((cad[i] >= 'A') && (cad[i] <= 'Z')) || (cad[i] == '.') || (cad[i] == '�') || (cad[i] == '�')
                            || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�')
                            || (cad[i] == '�') || (cad[i] == '�'))) {
            ...
            case 'A9':
                for (i = 0; i < cad.length; i++) {
                    if (!((cad[i] == '%') || (cad[i] == ' ') || ((cad[i] >= '0') && (cad[i] <= '9')) || ((cad[i] >= 'a') && (cad[i] <= 'z')) || ((cad[i] >= 'A') && (cad[i] <= 'Z')) || (cad[i] == '�') || (cad[i] == '�')
                            || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�') || (cad[i] == '�'))) {
