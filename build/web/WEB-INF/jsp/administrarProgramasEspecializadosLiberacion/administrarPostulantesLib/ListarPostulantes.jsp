...
<html lang="es">
    ...
    <body> 
        ...
        <tbody>
            <tr>
                <td>
                    <form id="fvolver" name="fvolver" action="<c:url value='/postulantesLib/entrada.fautapo'/>" method="post">
                ...
                <td>
                    <form id="fnuevo" name="fnuevo" action="<c:url value='/postulantesLib/nuevoPostulante.fautapo'/>" method="post">
                        <input type="hidden" name="id_proceso" value="<c:out value='${id_proceso}'/>">
                        <input type="hidden" name="id_tramite" value="<c:out value='${id_tramite}'/>">
                        <input type="hidden" name="titulo" value="<c:out value='${titulo}'/>">
            ...
            <tbody>
                <c:forEach var="lista" items="${lPstPersonas}" varStatus="contador">
                    <tr> 
                        ...
                        <td class="sub-title">
                            <form  id="fregistra<c:out value='${contador.count}'/>"  name="fregistra<c:out value='${contador.count}'/>" action="<c:url value='/postulantesLib/nuevoPrsPostulante.fautapo'/>" method="post"> 
                                <input type="hidden" name="id_proceso" value="<c:out value='${id_proceso}'/>">
                                <input type="hidden" name="id_tramite" value="<c:out value='${id_tramite}'/>">
                                <input type="hidden" name="titulo" value="<c:out value='${titulo}'/>">
