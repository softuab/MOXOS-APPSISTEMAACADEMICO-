...
<div class="titulo">Asignaci&oacute;n Docente Materias - Facultades</div>

<script language='JavaScript' SRC="../ajax.js"></script>
<tabla>
  <form name=formavolver<c:out value="${contador.count}"/> method=post action='<c:url value="/docentesFacultativa/listarMateriasProgramaPlan.fautapo"/>'>
    <td>
...
<br>
<form  name=forma  action="<c:url value="/docentesFacultativa/registrarAsignacionDocente.fautapo"/>" method=post>
  ...
  <table class="formulario">
	...
	<tr>
      ...
      <td class="etiqueta" colspan="2"> Honorable Consejo de Carrera<font color="red" >(*)</font>::&nbsp; 
         <input type="text" name='nro_resolucionhcc'  value='<c:out value="${datosAsignacion.nro_resolucionhcc}"/>' style="background-color:pink" readonly size="10">
      </td>
      <tr>	  
	  <td class="etiqueta" colspan="2">Honorable Consejo Facultativo.<font color="red" >(*)</font>::&nbsp; 
         <input type="text" name='nro_resolucionhcf'  value='<c:out value="${datosAsignacion.nro_resolucionhcf}" />' size="10">
      </td> 
	  </tr>
   ...
   <c:if test="${datosAsignacion.id_fase_resolucion == 1 || datosAsignacion.id_fase_resolucion==null}">
    <tr>
