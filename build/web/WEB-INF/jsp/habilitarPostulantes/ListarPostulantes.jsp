...
<table>
  <tr>
    <td>
     <form name="fvolver" action="<c:url value='/habilitarPst/entrada.fautapo'/>" method="post">
...
<form name="forma" action="<c:url value="/habilitarPst/mostrarPostulantes.fautapo"/>" method="POST">
  <table class="tabla">
  <tr>
