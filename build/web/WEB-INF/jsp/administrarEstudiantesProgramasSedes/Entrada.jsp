...
<html lang="es">
    ...
    <body>
        ...
        <br>
        <form id="forma" name=forma method="POST" action='<c:url value="/entradaEstudiante/ProgramaSede.fautapo"/>'>
                        ...
                        <td colspan="3">
                            <fieldset>
                                ...
                                <div class="grid-fieldset">
                                    <label style="text-align: right"><strong>RU ::</strong></label>
                                    <input type="number" name="id_estudiante" maxlength=8/>
                                    <input type=submit name="buscar" value='Buscar por R.U.' class="buscar" onClick="enviarSolicitud('forma')">

                                    <label style="text-align: right"><strong>DIP ::</strong></label>
                                    <input type=text name="ci" maxlength=35 onblur='validar(this, "A9")'>
                                    <input type=submit name="botonDip" value='Buscar por carnet' class="buscar" onClick="enviarSolicitud('forma')"> 
                                    <label style="text-align: right"><strong>Nombres ::</strong></label>
                                    <input type=text name="nombres" maxlength=35 onblur='validar(this, "A9")'>
                                    <input type=submit name="botonNombre" value='Buscar por nombres' class="buscar" onClick="enviarSolicitud('forma')">
                                </div>
                            </fieldset>
                        </td> 
                    </tr>
