...
<div class="titulo">Asignaci&oacute;n Docente Materias - Universitario</div>

<script language='JavaScript' SRC="../ajax.js"></script>
<tabla>
  <form name=formavolver<c:out value="${contador.count}"/> method=post action='<c:url value="/docentesUniversitaria/listarMateriasProgramaPlan.fautapo"/>'>
    <td>
  ...
  <table class="formulario">
	...
	<tr>
	 ...
	 <td class="etiqueta" colspan="2"> Honorable Consejo Universitario<font color="red" >(*)</font>::&nbsp; 
         <input type="text" name='nro_resolucionhcu'  value='<c:out value="${datosAsignacion.nro_resolucionhcu}"/>' size="10">
      </td> 
   ...
   <c:if test="${datosAsignacion.id_fase_resolucion == 2 || datosAsignacion.id_fase_resolucion==null}">
    <tr>
