...
<div class="titulo">Asignacion Docente Materias </div>
<br>
<tabla>
...
<br>
<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/docentesUniversitaria/listarMateriasProgramaPlan.fautapo"/>'>
  <input type="hidden" name="gestion" value='<c:out value="${gestion}"/>' >
  <input type="hidden" name="periodo" value='<c:out value="${periodo}"/>' >
