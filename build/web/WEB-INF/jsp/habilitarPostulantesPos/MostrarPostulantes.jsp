...
<br>
<form name="fvolver" action="<c:url value='/habilitarPstPos/listarPostulantes.fautapo'/>" method="post">
...
<br>
<form  name=forma action="<c:url value="/habilitarPstPos/habilitarPostulante.fautapo"/>" method="POST">
  <table class="tabla">
    <tr>
