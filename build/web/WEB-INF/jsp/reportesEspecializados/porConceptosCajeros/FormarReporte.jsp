...
<table width="100%">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h2>LISTA DE TRANSACCIONES - ANULADAS</h2></label></td>
      </tr>
	  <tr>
        <td align="lefth"><label>Cajero(a)::<c:out value='${nombres}'/></label></td>
      </tr>
	  <tr>
      ...
      <table class="tabla" width="100%">
        ...
        <c:forEach var="lista" items="${lTransacciones}" varStatus="contador">
          <tr>
			...
			<td align="center"><c:out value="${lista.nro_recibo}"/></td>
			<td><c:out value="${lista.perfil}"/></td>
			<td><c:out value="${lista.nombres}"/></td>
			<td><c:out value="${lista.fecha_ini}"/></td>
		  ...
		  <tr>
           <td colspan=7 height="1" style="border-top: 2px solid #000000; border-bottom: 2px solid #000000;" align="right">TOTAL&nbsp;&nbsp;&nbsp;&nbsp;</td>
