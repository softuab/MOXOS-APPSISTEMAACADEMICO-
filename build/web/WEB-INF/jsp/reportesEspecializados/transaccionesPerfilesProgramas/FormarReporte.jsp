    ...
    <tr>
      <td colspan=20>
        ...
        <table width="100%">
          <tr>
            ...
            <td width="60%">
              ...
              <label><center><h2>Lista de transacciones Por Perfiles y Programas</h2></center></label>
            </td>
            <td width="20%">
              <script>
                hora = new Date();
        ...
        <c:if test="${fec_comprobantei!=''}">
          <tr>
            <td>Programa : <c:out value="${datosPrograma.programa}"/></td>
            <td>Perfil : <c:out value="${datosPerfil.perfil}"/></td>
