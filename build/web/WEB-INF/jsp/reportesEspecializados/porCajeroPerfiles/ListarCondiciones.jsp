...
<!-- ************  Titulo  ********** -->
<div class="titulo">Total por Perfiles</div>
<br>
<br>
<!-- ************  fin Tititulo  ********** -->
...
<form name="forma" method="post" action="formarReporte.fautapo"  target="_blank">
  ...
  <table class="formulario">
    ...
    <tr>
      <th align="right">Cajero</th>
      <td>
        <select name="id_usuario">
          <c:forEach var="cajero" items="${lCajeros}">
            <option value="<c:out value='${cajero.id_usuario}'/>"><c:out value='${cajero.nombres}'/> <c:out value='${cajero.paterno}'/> <c:out value='${cajero.materno}'/></option>
          </c:forEach>
        </select>
      </td>
    </tr>
