...
<form  name="fvolver" method='post' action="<c:url value='/retiroAdicionMaterias/entrada.fautapo'/>">
  <div><a class="volver" href="javascript:document.fvolver.submit();">Volver</a></div>      
</form>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/retiroAdicionMaterias/comprobarEntrada.fautapo"/>'>
