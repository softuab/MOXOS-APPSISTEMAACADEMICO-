...
<!-- ============================================ TITULO 2 =========================================================== -->
	<table width="100%">
		<tr>
			...
			<td height= "30%"  width ="30%" align ="center"><font size="2"><b>PLAN DE ESTUDIO</b></font></td>
	...
	<table width = "100%" border = 0 >
		 ...
		 <tr>
		    <td colspan="3" width="100%" align="justify">
				...
				<IMG width="270" height="50" border="0" align="left" src='<c:url value="/"/>imagenes/CodigoBarra/CertificadoNotas/barcode_ha<c:out value='${NC1}'/>.jpg'>
