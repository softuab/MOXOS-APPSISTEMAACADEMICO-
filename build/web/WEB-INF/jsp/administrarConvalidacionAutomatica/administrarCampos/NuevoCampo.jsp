  ...
  <table class="formulario">
    ...
    <tr>
      ...
      <td>Si<input type="radio" name="referencia" value="true" <c:if test="${referencia == 'true'}"> checked </c:if> > &nbsp;
          No <input type="radio" name="referencia" value="false" <c:if test="${referencia == 'false' || empty referencia}">checked</c:if> > </td>
    </tr> 
    ...
    <tr>
      ...
      <td>Si<input type="radio" name="operacion" value="true" onchange="javascript:document.adicionarcampo.submit();" <c:if test="${operacion == 'true'}"> checked </c:if> > &nbsp;
          No<input type="radio" name="operacion" value="false" onchange="javascript:document.adicionarcampo.submit();"  <c:if test="${operacion == 'false' || empty operacion}">checked</c:if> > </td>
    </tr> 	  
    ...
    <tr>
      ...
      <td class="etiqueta">::</td>
      <td>Si<input type="radio" name="obligatorio" value="true" <c:if test="${obligatorio == 'true'}"> checked </c:if> > &nbsp;
          No<input type="radio" name="obligatorio" value="false" <c:if test="${obligatorio == 'false' || empty obligatorio}">checked</c:if> > </td>
    </tr> 
  </table>     
<!-- Fin Operaciones -->
  <center>
    <input type="submit" class="siguiente" value='Siguiente' onclick="document.adicionarcampo.accion1.value='Guardar';
								      document.adicionarcampo.action='<c:url value="/confirmarCampo.fautapo"/>'">
  </center>
