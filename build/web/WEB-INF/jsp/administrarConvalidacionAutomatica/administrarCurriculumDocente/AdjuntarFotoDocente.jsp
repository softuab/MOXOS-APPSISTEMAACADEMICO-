...
<div class="titulo">Adjuntando Foto Docente</div>
<br>
...
<form name="forma" method="POST" enctype='multipart/form-data'>
  ...
  <input type="submit" class="adjuntar" value="Adjuntar" onclick="document.forma.action='<c:url value="/docente/adjuntarFotoDocente1.fautapo">
