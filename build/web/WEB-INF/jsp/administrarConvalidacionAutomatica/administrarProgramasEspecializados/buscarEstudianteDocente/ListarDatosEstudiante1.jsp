...
<form name="forma" action="<c:url value="/listarInformesProceso1.fautapo"/>" method="POST">
  <table class="tabla">
    <tr>
    ...
    <tr>
      ...
      <td><c:out value="${dip}"/></td>
    </tr>
    <tr>
      <td class="etiqueta" align="right">Estudiante</td>
      <td class="etiqueta">::</td>
      <td>
        <c:out value="${datosEstudiante.nombre_completo}"/> &nbsp; 
      </td>
    </tr>
    ...
    <tr>
      ...
      <td class="etiqueta">::</td>
      <td><c:out value="${datosEstudiante.telefono}"/>
    </tr>

    <tr>
      <td class="etiqueta" align="right">Celular</td>
      <td class="etiqueta">::</td>
      <td><c:out value="${datosEstudiante.celular}"/>
    </tr>
...
<c:if test="${(id_tramite == null || id_tramite=='') && (!empty lTuplas)}">
  ...
  <input type="hidden" name="id_estudiante" value='<c:out value="${dip}"/>'>
  <input type="hidden" name="id_persona" value='<c:out value="${datosEstudiante.id_persona}"/>'>
