...
<br>
<form  name=forma action="<c:url value="/desBloquearMatricula/registrarDesBloquearMatricula.fautapo"/>" method="POST">
  <table class="formulario">
    ...
    <tr>
      <td colspan="2" align="center">
        <input type='submit' name="boton" value='Desbloquear' class="siguiente" >
