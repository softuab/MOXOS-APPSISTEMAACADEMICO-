...
<div class="titulo">Inscripci&oacute;n materias postulantes</div>
<br>
<form  name=forma action="<c:url value="/inscripcionMateriasPostulante/comprobarEntrada.fautapo"/>" method="POST">
