...
<br>
<form name="fvolver" action="<c:url value='/habilitarPstUABPROV/listarPostulantes.fautapo'/>" method="post">
...
<br>
<form  name=forma action="<c:url value="/habilitarPstUABPROV/habilitarPostulante.fautapo"/>" method="POST">
  <table class="tabla">
    <tr>
