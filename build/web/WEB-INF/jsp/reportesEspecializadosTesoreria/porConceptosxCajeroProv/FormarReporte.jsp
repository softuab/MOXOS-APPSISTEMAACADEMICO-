...
<!-- **************    VALORES     ************ -->
  ...
  <!-- **************    VALORES     ************ -->
   ...
   <c:forEach var="lista" items="${lTransacciones}" varStatus="contador">
          <c:set var="aux" value="${lista.nombres}" />	
          ...
          <c:if test="${subtotal !=0}">
           ...
           <tr> <td  colspan=6 height="1" style="border-top: 1px solid #000000; border-bottom: 0px solid #000000;" align="left"> <c:out value="${lista.nombres}"/> :: <c:out value="${lista.sede}"/> </td>
           </tr>   
           <c:set var="concepto" value="${lista.nombres}"/>		   
           <c:set var="id_concepto" value="${lista.nombres}"/>          
