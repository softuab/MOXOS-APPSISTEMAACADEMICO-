...
<table class = "tabla1">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h2>REPORTE - DETALLADO TESORO UNIVERSITARIO - POR CAJEROS - PROVINCIAS</h2></label></td>
      </tr>
	  <tr>
...
<!-- **************    VALORES     ************ -->
  ...
  <!-- **************    VALORES     ************ -->
   ...
   <c:forEach var="lista" items="${lTransacciones}" varStatus="contador">
          ...
          <c:if test="${subtotal !=0}">
            <tr>
               <td colspan=4 height="1" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000;" align="right">Sub Total&nbsp;&nbsp;&nbsp;&nbsp;</td>
               <td  height="1" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000;" align="right"> <c:out value="${subtotal}"/> </td>
               <td  height="1" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000;" align="right"> <c:out value="${subdescuento}"/> </td>
  ...
  <tr>
     <td colspan=4 height="1" style="border-top: 1px solid #000000; border-bottom: 2px solid #000000;" align="right">SubTotal&nbsp;&nbsp;&nbsp;&nbsp;</td>
