...
<form  name=forma  action="<c:url value="/docentes/registrarAsignacionDocente.fautapo"/>" method=post>
 ...
 <tr>
      <td colspan="2" class="etiqueta" colspan="2"> Funci&oacute;n Administrativa::</td>
      <td colspan="2"><c:out value="${datosAsignacion.nro_resolucion}"/>
      </td>
    </tr>     
    <tr>
  ...
  <!--  <tr>
	...
	<tr>
       <td colspan="2" class="etiqueta" colspan="2"> H.C.C. ::</td>
      <td colspan="2"><c:out value="${datosAsignacion.nro_resolucionhcc}"/>
      </td>
	   <td colspan="2" class="etiqueta" colspan="2"> H.C.F. ::</td>
      <td colspan="2"><c:out value="${datosAsignacion.nro_resolucionhcf}"/>
      </td>
    </tr>
	<tr>
       <td colspan="2" class="etiqueta" colspan="2"> H.C.U. ::</td>
      <td colspan="2"><c:out value="${datosAsignacion.nro_resolucionhcu}"/>
      </td>
	  </tr> 
    <tr>
