...
<body onload='inicio(document.forma.clave)'>
  ...
  <br>
  <form name="forma" action="<c:url value="/definirEvaluacion/listarAsignaciones.fautapo"/>" method="POST">
    ...
    <table class="formulario">
      ...
      <tr>
        ...
        <td class="etiqueta">::</td>
        <td><input type="text" name="periodo" value='<c:out value="${periodo}" />' onblur='validar(periodo,"9")' size="2" maxlength="2"> </td>
      </tr>
      <tr>
