...
<div class="titulo">EstudiantesNo Programados Por Programa</div>
<div class="volver"><a href='<c:url value="/reporteAuxiliaresPorPrograma/Entrada.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/reporteAuxiliaresPorPrograma/ListarEstudiantes.fautapo"/>' target="_blank">
