...
<body onload='inicio(document.forma.gestion)'>
  <div class="titulo">N&uacute;mero de Matriculados por Sexo y Nacionalidad</div>
  <br>
  <form name=forma action="<c:url value="/nroEstMatriculadosSexoNacionalidad/ListarMatriculados.fautapo"/>" method="POST" target="_blank">
