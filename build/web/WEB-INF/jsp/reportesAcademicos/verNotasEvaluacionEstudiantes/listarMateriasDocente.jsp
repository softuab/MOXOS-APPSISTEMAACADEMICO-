...
<div class="titulo">Ver Notas Evaluaci&oacute;n Continua</div>
  ...
  <c:if test="${ !empty datosAsignacion}">
	...
	<c:if test="${asignacion.id_modelo_ahorro <= 0}">
	  <td align="center">
        ...
        <form name='forma<c:out value="${contador.count}"/>' method='post' action="<c:url value='/listarEvaluacionContinuaEstudiantes.fautapo'/>">
          <td align="center">     
