                    ...
                    <div class="container-grid border">
                        ...
                        <div class="row">
                            <div class="col-xs-12 center bold">
                                SOLICITUD DE ADMISIÓN ESPECIAL 
                            </div>
                        </div> 
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12 center bold">
                                AUTORIZACIÓN DE ADMISIÓN ESPECIAL (CODEPEDIS)
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 justify">
                                <p>Al cumplir con las precisiones del Reglamento de Admisión Especial, la Dirección de
                                    ...
                                    <strong style="text-transform: uppercase;">ADMISION ESPECIAL INGRESO DIRECTO</strong>.
                                </p>
                            </div>
                        </div>
                        <div class="row">
