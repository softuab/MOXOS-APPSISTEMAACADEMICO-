...
<body onload='inicio(document.forma.clave)'>
  <div class="titulo">Estudiantes Inscritos Por Fechas</div>
  <br>
  <form name=forma action="<c:url value="/matriculadosPorProgramaTipoAdmision/ListarProgramasPlanes.fautapo"/>" method="POST">
