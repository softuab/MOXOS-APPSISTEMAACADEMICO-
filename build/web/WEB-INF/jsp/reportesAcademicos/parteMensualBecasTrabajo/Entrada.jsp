...
<script language='JavaScript' SRC="./validar.js"></script>
  ...
  <br>
  <form name=forma action="<c:url value="/parteMensualBecasTrabajo.fautapo"/>" method="POST">
    <table class="formulario">
      ...
      <tr>
        <td class="etiqueta">Unidad Funcional <font color="red"></td>
        <td class="etiqueta">::</td>      
	<td>
	    <c:out value="${ubicacion_organica.ubicacion_organica}"/>
	</td>  
      </tr>      
      <tr>
