...
<div class="titulo">Ver Asignaci&oacute;n Docentes</div>
<div class="volver"><a href='<c:url value="/asignacionDocentessintitular/verAsignacionDocentes.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/asignacionDocentessintitular/ListarDocentesMaterias.fautapo"/>'>
