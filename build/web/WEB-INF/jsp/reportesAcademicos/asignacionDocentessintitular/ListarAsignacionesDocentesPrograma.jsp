      ...
      <tr>
        ...
        <th> 
			<table class="tabla" width="100%" border = "0"> 
				<tr>
					<td width = "60%" style=" border: 0px"> MATERIA</td>
					<td width = "15%" style=" border: 0px">SIGLA</td>
					<td width = "5%" align="center" style=" border: 0px">NIVEL</td>
					<td width = "5%" align="center" style=" border: 0px">GRUPO</td>
					<td width = "5%" style=" border: 0px">HRS</td>
					<td width = "10%" style=" border: 0px">TIPO</td>
				</tr>  
			</table>
		</th>
      	<th>DEDICACION</th>
   	   ...
   	   <tr <c:if test="${(contador2.count mod 2) == 0}">bgColor="#FFFFD9" %-- Est&acute;tico :( --%</c:if> onMouseOver="this.className='sobreFila'" onmouseout="this.className=''">
				...
				<td><c:out value="${contador2.count}"/></td>
				
				<td><c:out value="${nroasignacion.dip}"/></td>
				<td><c:out value="${nroasignacion.paterno}"/></td>
				<td><c:out value="${nroasignacion.materno}"/></td>
				<td><c:out value="${nroasignacion.nombres}"/></td>
				<td><c:out value="${nroasignacion.descripcion}"/></td> 
				<td rowspan = "1" >
				   <table class="tabla" width="100%" border = "0">
			      ...
			      <td><c:out value="${nroasignacion.tipo_asignacion}"/></td> 
	        </c:forEach>  
	 </table>
  </tbody>
  </table>
