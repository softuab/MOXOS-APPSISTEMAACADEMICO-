...
<div class="titulo">N&uacute;mero de Matriculados por Sexo y Tipo de Estudiante</div>
<br>
<form name=forma action="<c:url value="/nroEstMatriculadosSexo/ListarMatriculados.fautapo"/>" method="POST" target="_blank">
