...
<div class="volver"><a href='<c:url value="/calendarioAcademico/verActaCalificaciones.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/calendarioAcademico/ListarDocentesActaCalificaciones.fautapo"/>'>
