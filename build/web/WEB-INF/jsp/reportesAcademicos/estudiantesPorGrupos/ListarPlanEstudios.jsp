...
<div class="titulo">Estudiantes por Grupos</div>
<form name="fvolver" method="POST" action='<c:url value="/estudiantesPorGrupos/ListarProgramasPlanes.fautapo"/>' >
...
<form name="forma" method="POST" action='<c:url value="/estudiantesPorGrupos/ListarEstudiantes.fautapo"/>' target="_blank">
