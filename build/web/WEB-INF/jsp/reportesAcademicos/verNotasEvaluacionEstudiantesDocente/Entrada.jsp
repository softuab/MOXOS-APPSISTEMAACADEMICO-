...
<body onload='inicio(document.forma.clave)'>
  <div class="titulo">Reporte Notas Evaluaci&oacute;n Estudiante-Docente </div>
  <br>
  <form name=forma action="<c:url value="/docente/listarDctMateriasDocente.fautapo"/>" method="POST">
