  ...
  <c:if test="${ !empty lDatosAsignacion}">
	...
	<c:if test="${asignacion.id_modelo_ahorro <= 0}">
	  <td align="center">
        ...
        <form name='forma<c:out value="${contador.count}"/>' method='post' action="<c:url value='/docente/listarEstudiantesEvaluacion.fautapo'/>">
          <td align="center">     
            <a href='javascript:document.forma<c:out value="${contador.count}"/>.submit();'>Ver Libreta </a>
