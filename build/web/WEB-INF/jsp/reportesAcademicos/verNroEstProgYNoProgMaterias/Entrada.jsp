...
<body onload='inicio(document.forma.clave)'>
  <div class="titulo">Ver N&uacute;mero de Estudiantes Programados y no Programados por Materias</div>
  <br>
  <form name=forma action="<c:url value="/formularioGradosProgramasProgYNoProg.fautapo"/>" method="POST">
