...
<div class="titulo">Estudiantes por Niveles Academicos</div>
<div class="volver"><a href='<c:url value="/entradaNivelesAcademicos.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/listarNivelesAcademicos.fautapo"/>' target="_blank">
