...
<div class="titulo">Nro de Postulantes Aprobados - Inscritos x Programa  Tipo Admisi&oacute;n</div>
<div class="volver"><a href='<c:url value="/nroPstInscritosAprobadosProgramaTipoAdmision/Entrada.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/nroPstInscritosAprobadosProgramaTipoAdmision/ListarNumeroInscritos.fautapo"/>'>
  <input type="hidden" name="gestion" value='<c:out value="${gestion}"/>'>
  <input type="hidden" name="periodo" value='<c:out value="${periodo}"/>'>
<table class="formulario">
  <tr>
    <th colspan="3">REPORTE POSTULANTES</th>
  </tr>
  <tr>
    <td class="etiqueta">
      <c:choose>
