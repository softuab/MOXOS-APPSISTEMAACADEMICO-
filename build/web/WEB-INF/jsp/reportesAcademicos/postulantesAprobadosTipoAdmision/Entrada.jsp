...
<body onload='inicio(document.forma.clave)'>
  <div class="titulo">Postulantes Aprobados Por Tipo Admisi&oacute;n</div>
  <br>
  <form name=forma action="<c:url value="/postulantesAprobados/ListarProgramas.fautapo"/>" method="POST">
