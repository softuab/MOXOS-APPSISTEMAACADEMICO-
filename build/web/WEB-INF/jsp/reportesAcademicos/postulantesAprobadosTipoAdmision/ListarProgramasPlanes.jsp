...
<div class="titulo">Postulante Aprobados por Tipo Admisi&oacute;n</div>
<div class="volver"><a href='<c:url value="/postulantesAprobados/Entrada.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/postulantesAprobados/ListarPostulantes.fautapo"/>'>
