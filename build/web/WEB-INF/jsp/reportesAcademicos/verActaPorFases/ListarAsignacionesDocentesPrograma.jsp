...
<c:if test="${!empty id_rol}">
  ...
  <br>
  <tabla>
    <form name=formavolver<c:out value="${contador.count}"/> method=post action='<c:url value="/actaPorFases/ListarDepartamentosTiposEvaluaciones.fautapo"/>'>
      <td>
  ...
  <c:if test="${ !empty lAsignacionDocentesProgramaPlan}">
	...
	<th>DOCENTE</th>
	<th>FASE</th>
        <th colspan="3">VER ACTA DE CALIFICACIONES</th>
      </tr>
