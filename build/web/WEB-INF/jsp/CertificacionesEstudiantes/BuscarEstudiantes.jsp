...
<html lang="es">
    ...
    <body>
        ...
        <br>
        <form id="forma" action="<c:url value='/certificaciones/buscarEstudianteEntrada.fautapo'/>" method="get">
                        ...
                        <td colspan="3">
                            <fieldset>
                                ...
                                <div class="grid-fieldset">
                                    ...
                                    <input value='Buscar por R.U.' type="Button" class="buscar" onClick="enviarSolicitud('forma')">
