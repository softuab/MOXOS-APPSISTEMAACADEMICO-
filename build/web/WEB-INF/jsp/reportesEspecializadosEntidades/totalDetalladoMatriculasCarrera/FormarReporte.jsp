...
<table class = "tabla1">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h2>REPORTE  DETALLADO - POR CARRERA</h2></label></td>
      </tr>
	  <tr>
...
<c:set var="subtotal" value="0"/>
  ...
  <tbody>
      <table class="tabla" width="100%">
		...
		<c:set var="aux" value="${lista.programa}"/>	
          <c:if test="${aux != programa}">            
          <c:if test="${subtotal !=0}">
			...
			<tr> 
				<td  colspan=6 height="1" style="border-top: 1px solid #000000; border-bottom: 0px solid #000000;" align="left"> <c:out value="${lista.programa}"/> </td>
			</tr>   
			<c:set var="programa" value="${lista.programa}"/>		   
			<c:set var="subtotal" value="0"/>
          </c:if> 
		 ...
		 <tr>
			<td colspan=3 height="1" style="border-top: 1px solid #000000; border-bottom: 2px solid #000000;" align="right">Sub Total&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<table width="68%"  class="tabla" style="border-top: 2px solid #000000;border-bottom: 2px solid #000000;">
		<tr>
			<th class='etiqueta' align="center"><div class="clave" align="left">TOTAL DETALLADO </th>
