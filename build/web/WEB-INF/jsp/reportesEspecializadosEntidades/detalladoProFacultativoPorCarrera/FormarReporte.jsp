  ...
  <!-- **************    VALORES     ************ 
   ...
   <c:forEach var="lista" items="${lTransacciones}" varStatus="contador">
          ...
          <c:if test="${subtotal !=0}">
           ...
           <tr> <td  colspan=6 height="1" style="border-top: 1px solid #000000; border-bottom: 0px solid #000000;" align="left"> <c:out value="${lista.nro_recibo}"/> :: <c:out value="${lista.concepto}"/></td>
           </tr>   
