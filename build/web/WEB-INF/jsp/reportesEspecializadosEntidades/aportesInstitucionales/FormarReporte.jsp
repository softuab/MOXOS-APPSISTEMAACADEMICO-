...
<table class = "tabla1">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h2>RESUMEN OBLIGACIONES DIVERSAS INSTITUCIONALES - POR ENTIDADES FINANCIERAS</h2></label></td>
      </tr>
	  <tr>
  ...
  <!-- **************    VALORES     ************ -->
   ...
   <c:forEach var="lista" items="${lTransacciones}" varStatus="contador">
          ...
          <c:if test="${subtotal !=0}">
           ...
           <tr> <td  colspan=6 height="1" style="border-top: 1px solid #000000; border-bottom: 0px solid #000000;" align="left"> <c:out value="${lista.nro_recibo}"/></td>
           </tr>   
