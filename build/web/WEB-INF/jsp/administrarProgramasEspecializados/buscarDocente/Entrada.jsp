...
<form name="forma" action="<c:url value="/listarDatosDocente.fautapo"/>" method="POST">
  <table class="formulario">
  <tr>
    <th colspan="3" align="center">INTRODUZCA LOS DATOS</th>
  </tr>
  <tr>
    <td class="etiqueta" align="right">Registro del Docente <font color='red'>(*)</font> </td>
    <td class="etiqueta">::</td>
    <td><input type="text" name="id_docente" onblur='validar(this,"9")'></td>
  </tr>
  <tr>
