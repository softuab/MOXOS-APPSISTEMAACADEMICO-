                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table class="left font-10">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="4"><strong>Postulante</strong> <c:out value="${postulante.nombres}"/> <c:out value="${postulante.paterno}"/> <c:out value="${postulante.materno}"/></td> 
                                        </tr>
                                        <tr>
                                            <td colspan="4"><strong>Programa</strong> <c:out value="${postulante.programa}"/></td> 
                                        </tr>
                                        <tr>
                                            <td><strong>R.P.</strong> <c:out value="${postulante.id_postulante}"/></td>
                                            <td><strong>DIP</strong> <c:out value="${postulante.dip}"/></td>
