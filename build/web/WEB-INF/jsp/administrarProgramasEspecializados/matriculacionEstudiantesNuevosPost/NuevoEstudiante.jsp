...
<html lang="es">
    ...
    <body onload="init()">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="group-form">
                                                ...
                                                <input type="text" name="paterno" onkeyup="fmayus();" style="background-color:pink" value="<c:out value='${bPst.paterno}'/>" />
                                            </div>
                                        </td>	
                                        <td >
                                            <div class="group-form">
                                                <label>2do. Apellido</label>
                                                <input type="text" name="materno" onkeyup="fmayus();" style="background-color:pink" value="<c:out value='${bPst.materno}'/>" />
                                            </div>
                                        </td>	
                                        <td>
                                            <div class="group-form">
                                                <label>Nombres <span class="obligatorio">(*)</span></label>
                                                <input type="text" name="nombres" size="20" title="Nombres"  onkeyup="fmayus();" style="background-color:pink" value="<c:out value='${bPst.nombres}'/>" />
                                            </div>
                                        </td> 
                                    </tr>   
                                    <tr> 
                                        <td>
                                            <div class="group-form">
                                                ...
                                                <input type="text"  name="dip"  style="background-color:pink" value="<c:out value='${bPst.dip}'/>" readonly />
                                            </div>
                                        </td>
                                        <td>
                                            <div class="group-form">
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <div class="group-form">
                                                ...
                                                <input type="text"  name="telefono" value="<c:out value='${bPst.telefono}'/>"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="group-form">
                                                <label>Correo</label>
                                                <input type="text"  name="correo"  value="<c:out value='${bPst.correo}'/>"/>
                                            </div>
                                        </td>
                                    </tr> 
                                    <tr> 
                                        <td>
                                            <div class="group-form">
                                                <label>Celular</label>
                                                <input type="text"  name="celular" value="<c:out value='${bPst.celular}'/>"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="group-form">
                                            ...
                                            <div class="group-form">
                                                ...
                                                <select id = 'id_pais_n' name = 'id_pais_n'  onChange = "cambiardepartamentos(this)"> 
                                                    ...
                                                    <c:forEach var="item" items="${lPaises}" >
                                                        <option value='<c:out value="${item.id_pais}"/>' <c:if test="${item.id_pais ==  bPst.id_pais}"> selected </c:if>>
                                            ...
                                            <div class="group-form">
                                                ...
                                                <select id = 'id_tipo_institucion' name = 'id_tipo_institucion'   onChange = "cambiarcolegios(this)">
                                                    ...
                                                    <c:forEach var="item" items="${lTiposInstituciones}" >
                                                        <option value='<c:out value="${item.id_tipo_institucion}"/>' <c:if test="${item.id_tipo_institucion ==  bPstColegio.id_tipo_institucion}"> selected </c:if>>
                                            ...
                                            <div class="group-form">
                                                ...
                                                <select id = 'id_tipo_turno' name = 'id_tipo_turno'>
                                                    ...
                                                    <c:forEach var="item" items="${lTiposTurnos}" >
                                                        <option value='<c:out value="${item.id_tipo_turno}"/>' <c:if test="${item.id_tipo_turno ==  bPstColegio.id_tipo_turno}"> selected </c:if>>
                                    ...
                                    <tr> 
                                        <td colspan="3">
                                            <div class="group-form">
                                                ...
                                                <input type="text"  name="anio_titulacion"  placeholder="Anio Egreso" value="<c:out value='${gestion}'/>"/>
                                            </div>
                                        </td>  
                                    </tr> 
                                    <tr>
                                    ...
                                    <tr> 
                                        ...
                                        <td colspan="2">
                                            <div class="group-form">
                                                ...
                                                <input type="text"  name="nro_seguro_medico" />
                                            </div> 
                                        </td> 
                                    </tr> 
                                    <tr>
                                    ...
                                    <tr> 
                                        <td>
                                            <div class="group-form">
                                                ...
                                                <input type="text"  name="nro_hijos"/>
                                            </div>
                                        </td>
                                        <td colspan="2">
                                            <div class="group-form">
                                                <label>Nro. Dependientes</label>
                                                <input type="text"  name="nro_dependientes"/>
                                            </div> 
                                        </td>
                                    </tr>
                                </tbody>
        ...
        <script>
                                ...
                                var idPais =${bPst.id_pais};
                                var idDepartamento =${bPst.id_departamento};
                                var idProvincia =${bPst.id_provincia};
                                var idLocalidad =${bPst.id_localidad};
                                var idTipoInstitucion =${bPstColegio.id_tipo_institucion};
                                var idColegio =${bPstColegio.id_colegio};
