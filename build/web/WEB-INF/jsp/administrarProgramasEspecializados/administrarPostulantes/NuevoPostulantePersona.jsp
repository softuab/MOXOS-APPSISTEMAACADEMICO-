    ...
    <body onload="init()">
        ...
        <form  name=forma action="<c:url value="/postulantes/registrarPrsPostulante.fautapo"/>" method="POST">
            <table class="formulario" aria-describedby="formulario de registro de etudiante">
                ...
                <tbody>
                    <tr>
                        <td class="etiqueta4">Gesti&oacute;n<span class="obligatorio">(*)</span>::</td>
                        <td>
                            <input type="text" name="gestion" value="<c:out value="${gestion}"/>" size="4"  maxlength="4" onblur='validar(this, "9")' >
                        </td>
                    </tr>
                    <tr>
                        <td class="etiqueta4">Periodo<span class="obligatorio">(*)</span>::</td>
                        <td>
                            <input type="text" name="periodo" value="<c:out value="${periodo}"/>" size="2"  maxlength="2" onblur='validar(this, "9")' >
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="group-form">
                                                ...
                                                <input type="text" name="paterno" onkeyup="fmayus();" value="<c:out value='${datosPstPersona.paterno}'/>"  />
                                            </div>
                                        </td>	
                                        <td >
                                            <div class="group-form">
                                                <label>2do. Apellido</label>
                                                <input type="text" name="materno" onkeyup="fmayus();"  value="<c:out value='${datosPstPersona.materno}'/>" />
                                            </div>
                                        </td>	
                                        <td>
                                            <div class="group-form">
                                    ...
                                    <tr> 
                                        <td>
                                            <div class="group-form">
                                                ...
                                                <input type="text"  name="dip" value="<c:out value='${datosPstPersona.dip}'/>" />
                                            </div>
                                        </td>
                                        <td>
                                            <div class="group-form">
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <div class="group-form">
                                                ...
                                                <input type="text"  name="telefono" value="<c:out value='${datosPstPersona.telefono}'/>"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="group-form">
                                                <label>Correo</label>
                                                <input type="text"  name="correo"  value="<c:out value='${datosPstPersona.correo}'/>"/>
                                            </div>
                                        </td>
                                    </tr> 
                                    <tr> 
                                        <td>
                                            <div class="group-form">
                                                <label>Celular</label>
                                                <input type="text"  name="celular" value="<c:out value='${datosPstPersona.celular}'/>"/>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="group-form">
                                    ...
                                    <tr>     
                                        ...
                                        <td colspan="2">
                                            <div class="group-form">
                                                ...
                                                <div class="date">
                                                    <div  class="item1">
                                                        <input type="text" name='fec_nacimiento'  value='<fmt:formatDate value="${datosPstPersona.fec_nacimiento2}" pattern="${formatoFecha}"/>' maxlength='10' size='10' placeholder="Fecha de nacimiento" /> 
                                                    </div>
                                                    <div  class="item2">
                    ...
                    <tr>
                        <td colspan="2">
                            <table class="tabla">
                                <thead>
                                    <tr>
                                        <th scope="numero">Nro.</th>
                                        <th scope="tipo deocumento">Tipo Documento</th>
                                        <th scope="cantidad">Cantidad</th>
                                        <th scope="Observaciones">Oobservaciones</th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <script>
                                ...
                                var lTiposAdmisiones = ${lTiposAdmisiones};
            ...
            <c:forEach var="lista1" items="${lTiposDescuentos}" varStatus="contador">
                                ...
                                const init = () => {
                                    ...
                                    document.getElementById('id_tipo_admision').innerHTML = optionscollectioncomplete(lTiposAdmisiones, idPrograma, -1);
                                ...
                                const cambiarplanes = (e) => {
                                    ...
                                    document.getElementById('id_tipo_admision').innerHTML = optionscollectioncomplete(lTiposAdmisiones, parseInt(e.value), -1);
                                };
