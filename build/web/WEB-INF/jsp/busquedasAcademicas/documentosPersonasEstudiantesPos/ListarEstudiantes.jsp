...
<div class="titulo">Actualizar Documentos Estudiante</div>
<br>
<div class="volver"><a href='<c:url value="/documentospos/buscarEstudianteEntrada.fautapo"/>'>Volver</a></div>
<table class="tabla">
  <tr>
    <th>Nro.</th>
    <th>RU</th>
  ...
  <c:forEach var="datos" items="${lEstudiantes}" varStatus="contador">
     ...
     <!-- ********** Fin  efecto ************ --> 
      ...
      <form name='forma<c:out value="${contador.count}"/>' method='post' action="<c:url value='/documentospos/modificarDocumentosEstudiante.fautapo'/>">
          <td align="center">
