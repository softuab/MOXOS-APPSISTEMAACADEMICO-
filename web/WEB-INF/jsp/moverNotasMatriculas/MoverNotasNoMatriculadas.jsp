...
<div class="titulo">Mover Notas No Matriculadas</div>
<br>
<form name="forma" action='<c:url value="/grabarNotasNoMatriculadas.fautapo"/>' method="post">
...
<table class="formulario" >
  ...
  <tr>
    <td class="etiqueta" align="right">Clave (PIN)</td>
    <td class="etiqueta">::</td>
    <td><input type="password" name='clave<fmt:formatDate value="${now}" pattern="yyyyMMddhhmmss" />'></td>
  </tr>
  <tr>
    <td colspan="3" align="center"><input type="submit" value="Buscar" class="buscar"></td>
  </tr>
</table>
</form>
