...
<html lang="es">
    ...
    <body> 
        ...
        <br>
        <form id="forma"   name=forma action="<c:url value="/postulantesLib/registrarPerfilPostulante.fautapo"/>" method="POST"> 
            <table class="formulario">
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <button onClick="enviarSolicitud('forma')" type='button' id="btnenviar"  role="button"  class="btn">Seguiente</button>  
