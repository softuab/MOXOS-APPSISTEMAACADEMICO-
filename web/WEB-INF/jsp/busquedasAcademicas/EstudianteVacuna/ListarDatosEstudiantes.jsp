...
<div class="titulo">Ver Datos Estudiantes</div>
<form name="fvolver" action="mostrarDatos.fautapo" method="post">
...
<table class="tabla">
  ...
  <c:forEach var="datos" items="${lEstudiantes}" varStatus="contador">
   <form name=forma<c:out value="${contador.count}"/> method="POST" action="mostrarDatos.fautapo">
     ...
     <!-- ********** Fin  efecto ************ -->
      ...
      <td><a href="javascript: document.forma<c:out value="${contador.count}"/>.submit()">Registro Vacuna</a>
