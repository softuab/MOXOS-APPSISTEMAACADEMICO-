...
<html lang="es">
    ...
    <body>
        ...
        <table>
            <tr>
                <td>
                    <form id="fvolver" name="fvolver" action="<c:url value="/certificaciones/buscarEstudianteEntrada.fautapo"/>" method="get">
                            ...
                            <tr class="filter">
                                <td>
                                    <label class="dropdown">
                                        ...
                                        <ul class="dd-menu"> 
                                            <li class="divider"></li>
                                            <li onclick="enviarSolicitud('forma<c:out value="${contador.count}"/>');">
                                                <form id="forma<c:out value="${contador.count}"/>" name=forma<c:out value="${contador.count}"/> method="Get" action='<c:url value="/certificaciones/afp/EntradaImpresion.fautapo"/>'>
