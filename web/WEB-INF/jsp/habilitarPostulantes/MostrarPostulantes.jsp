...
<br>
<form name="fvolver" action="<c:url value='/habilitarPst/listarPostulantes.fautapo'/>" method="post">
...
<br>
<form  name=forma action="<c:url value="/habilitarPst/habilitarPostulante.fautapo"/>" method="POST">
  <table class="tabla">
    <tr>
