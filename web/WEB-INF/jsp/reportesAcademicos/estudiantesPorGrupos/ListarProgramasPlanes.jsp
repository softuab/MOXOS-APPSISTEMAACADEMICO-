...
<div class="titulo">Listado de Estudiantes por Grupo</div>
<div class="volver"><a href='<c:url value="/estudiantesPorGrupos/Entrada.fautapo"/>'>Volver</a></div>

<form name='forma' method="post" action='<c:url value="/estudiantesPorGrupos/ListarPlanEstudios.fautapo"/>'>
