...
<body onload='inicio(document.forma.gestion)'>
  <div class="titulo">N&uacute;mero de Matriculados</div>
  <br>
  <form name=forma action="<c:url value="/nroEstudiantesMatriculados/ListarMatriculados.fautapo"/>" method="POST" target="_blank">
