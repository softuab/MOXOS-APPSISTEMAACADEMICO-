...
<div class="titulo">Nro. de Estudiantes Aprobados, Reprobados y Abandonos</div>
<div class="volver"><a href='<c:url value="/nroEstProgramadosMaterias/Entrada.fautapo"/>'>Volver</a></div>
...
<form name='forma' method="post" action='<c:url value="/nroEstProgramadosMaterias/ListarEstudiantes.fautapo"/>' target="_blank">
