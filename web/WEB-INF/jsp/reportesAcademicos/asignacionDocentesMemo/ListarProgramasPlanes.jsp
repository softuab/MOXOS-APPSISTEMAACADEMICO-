...
<div class="volver"><a href='<c:url value="/asignacionDocentesMemo/verAsignacionDocentes.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/asignacionDocentesMemo/ListarDocentesMaterias.fautapo"/>'>
