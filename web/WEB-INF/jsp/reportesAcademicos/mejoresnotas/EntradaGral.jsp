...
<body onload='inicio(document.forma.clave)'>
    <div class="titulo">Listar estudiantes mayores a 80 sin modalidad</div>
    <br>
    <form name=forma action="<c:url value="/MayoresNotasEstudiantes/ListarNotaMayoresGral.fautapo"/>" method="POST">
