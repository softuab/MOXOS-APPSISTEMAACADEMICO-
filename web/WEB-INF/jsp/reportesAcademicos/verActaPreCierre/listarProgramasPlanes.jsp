...
<form name="fvolver" method="POST" action="/actaPreCierre/verActaCalificaciones.fautapo">

  <div class="volver"><a href='javascript: document.fvolver.submit();' > Volver </a></div>
</form>

<form name='forma' method="post" action='<c:url value="/actaPreCierre/listarDocentesActaCalificaciones.fautapo"/>'>
