...
<div class="titulo">Nro de Postulantes Aprobados - Inscritos x Programa</div>
<div class="volver"><a href='<c:url value="/nroPstInscritosAprobadosPrograma/Entrada.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/nroPstInscritosAprobadosPrograma/ListarNumeroInscritos.fautapo"/>'>
