...
<div class="titulo">N&uacute;mero de Matriculados por Tipo Estudiante</div>
<br>

<body onload='inicio(document.forma.gestion)'>
  <form name=forma action="<c:url value="/nroEstMatriculadosTipoEstudiante/ListarMatriculados.fautapo"/>" method="POST" target="_blank">
