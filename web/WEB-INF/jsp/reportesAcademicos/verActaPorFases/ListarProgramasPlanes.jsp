...
<div class="volver"><a href='<c:url value="/actaPorFases/verActaCalificaciones.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/actaPorFases/ListarDocentesActaCalificaciones.fautapo"/>'>
