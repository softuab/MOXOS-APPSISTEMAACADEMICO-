...
<table border="0" width="100%">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h1>N&Uacute;MERO DE MATRICULADOS POR SEXO Y NACIONALIDAD</h1></label></td>
      </tr>
    </table>
    <table border="0">
      <tr>
    ...
    <table class="tabla" border="1" width="97%">
	  ...
	  <c:forEach var="lpais" items="${lPaises}">
	      ...
	      <c:forEach var="lestudiante" items="${lEstudiantes}">
	        <c:if test="${lestudiante.nacionalidad == lpais.nacionalidad && lestudiante.tipo_sexo == ltsexos.tipo_sexo && lestudiante.id_programa == lprograma.id_programa}">
