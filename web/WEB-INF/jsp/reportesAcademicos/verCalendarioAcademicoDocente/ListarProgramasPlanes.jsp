...
<div class="titulo">Ver Calendario de acuerdo a la Carrera</div>
<div class="volver"><a href='<c:url value="/calendarioAcademicoDocente/verActaCalificaciones.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/calendarioAcademicoDocente/ListarDocentesActaCalificaciones.fautapo"/>'>
