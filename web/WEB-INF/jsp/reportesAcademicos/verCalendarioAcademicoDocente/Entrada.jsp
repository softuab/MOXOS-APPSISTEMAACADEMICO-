...
<body onload='inicio(document.forma.clave)'>
  <div class="titulo">Reporte De Calendario Academico</div>
  <br>
  <form name=forma action="<c:url value="/calendarioAcademicoDocente/ListarDepartamentosTiposEvaluaciones.fautapo"/>" method="POST">
