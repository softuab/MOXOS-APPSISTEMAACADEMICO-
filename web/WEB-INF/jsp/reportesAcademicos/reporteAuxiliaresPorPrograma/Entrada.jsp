...
<body onload='inicio(document.forma.clave)'>
  <div class="titulo">Estudiantes No Programados</div>
  <br>
  <form name=forma action="<c:url value="/reporteAuxiliaresPorPrograma/ListarProgramasPlanes.fautapo"/>" method="POST">
