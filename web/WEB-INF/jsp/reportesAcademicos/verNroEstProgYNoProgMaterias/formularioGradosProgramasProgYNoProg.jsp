...
<div class="titulo">Ver Numero de Estudiantes Programados y no Programados por Materias </div>
<form name="fvolver" method="POST" action="./verNroEstProgYNoProgMaterias.fautapo">
  <div class="volver"><a href='javascript: document.fvolver.submit();' > Volver </a></div>
</form>

<form name='forma' method="post" action='listarNroEstProgYNoProgMaterias.fautapo' target="_blank">
