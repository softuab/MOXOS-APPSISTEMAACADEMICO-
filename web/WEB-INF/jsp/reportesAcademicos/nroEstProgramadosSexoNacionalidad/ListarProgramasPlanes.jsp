...
<div class="titulo">Nro. de Programados por Sexo y Nacionalidad</div>
<div class="volver"><a href='<c:url value="/nroEstProgramadosSexoNacionalidad/Entrada.fautapo"/>'>Volver</a></div>
...
<form name='forma' method="post" action='<c:url value="/nroEstProgramadosSexoNacionalidad/ListarEstudiantes.fautapo"/>' target="_blank">
...
<table class="formulario">
  ...
  <tr>
    <td class="etiqueta">Tipo de Evaluaci&oacute;n <font color="red">(*)</td>
    <td class="etiqueta">::</td>
    <td>
