...
<body onload='inicio(document.forma.gestion)'>
  <div class="titulo">N&uacute;mero de Matriculados por Nacionalidad y Tipo Estudiante</div>
  <br>
  <form name=forma action="<c:url value="/nroEstMatriculadosNacionalidad/ListarEstudiantes.fautapo"/>" method="POST" target="_blank">
