...
<div class="volver"><a href='<c:url value="/matriculadosPorProgramaPost/Entrada.fautapo"/>'>Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/matriculadosPorProgramaPost/ListarEstudiantes.fautapo"/>' target="_blank">
