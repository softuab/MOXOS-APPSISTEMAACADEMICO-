...
<table class="tabla">
  ...
  <c:forEach var="cod" items="${lTramitesParalelos}" varStatus="contador">
     ...
     <!-- ********** Fin  efecto ************ -->
    <form name='forma<c:out value="${contador.index}"/>' method=post action='<c:url value="/listarDetalleTramite2.fautapo"/>' >
      <td><c:out value="${cod.correlativo2}"/></td>
      ...
      <td><fmt:formatDate value="${cod.fec_registro}" pattern='dd/MM/yyyy HH:mm'/></td>
