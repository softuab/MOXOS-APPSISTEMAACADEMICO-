...
<table class = "tabla1">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h2>REPORTE - TOTAL DETALLADO - POR CAJEROS</h2></label></td>
      </tr>
	  <tr>
...
<th>Pagado</th>					
		...
		<c:set var="aux" value="${lista.programa}"/>	
          ...
          <tr>
			...
			<td align="center"><c:out value="${lista.descuento}"/></td>	
			<td align="center"><c:out value="${lista.pagado}"/></td>	
