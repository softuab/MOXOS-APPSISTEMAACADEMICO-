...
<table width="100%">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h2>LISTA DE TRANSACCIONES - POR CAJEROS</h2></label></td>
      </tr>
	  <tr>
...
<td align="center"><c:out value="${lista.sede}"/></td>			
		  ...
		  <tr>
           <td colspan=8 height="1" style="border-top: 2px solid #000000; border-bottom: 2px solid #000000;" align="right">TOTAL&nbsp;&nbsp;&nbsp;&nbsp;</td>
