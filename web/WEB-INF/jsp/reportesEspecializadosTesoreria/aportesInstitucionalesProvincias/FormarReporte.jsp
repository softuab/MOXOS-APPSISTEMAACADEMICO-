...
<table class = "tabla1">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h2>RESUMEN - OBLIGACIONES DIVERSAS INSTITUCIONALES - POR PROVINCIAS - POR CAJEROS</h2></label></td>
      </tr>
	  <tr>
...
<!-- **************    VALORES     ************ -->
   ...
   <c:forEach var="lista" items="${lTransacciones}" varStatus="contador">
       ...
       <tr>        
           ...
           <!--   <c:set var="aux" value="${lista1.id_concepto}"/>         -->
              ...
              <c:set var="total" value="${total + lista.pagado}"/>
  ...
  <tr>
     <td colspan=5 height="1" style="border-top: 1px solid #000000; border-bottom: 2px solid #000000;" align="right">SubTotal&nbsp;&nbsp;&nbsp;&nbsp;</td>
  ...
  <tr>
     <td colspan=5 height="1" style="border-top: 2px solid #000000; border-bottom: 2px solid #000000;" align="right">TOTAL&nbsp;&nbsp;&nbsp;&nbsp;</td>
