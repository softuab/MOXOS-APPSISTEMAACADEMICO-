...
<table class = "tabla1">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h2>RESUMEN - OBLIGACIONES DIVERSAS ESTUDIANTILES - PROVINCIAS- POR CAJEROS</h2></label></td>
      </tr>
	  <tr>
...
<!-- **************    VALORES     ************ -->
  ...
  <!-- **************    VALORES     ************ -->
   ...
   <c:forEach var="lista" items="${lTransacciones}" varStatus="contador">
          <c:set var="aux" value="${lista.sede}"/>	
          <c:if test="${aux != concepto}">            
          
          <c:if test="${subtotal !=0}">
            <tr>
               <td colspan=5 height="1" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000;" align="right">Sub Total&nbsp;&nbsp;&nbsp;&nbsp;</td>
               <td  height="1" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000;" align="right"> <c:out value="${subtotal}"/> </td>
               
           </tr>
           </c:if>          
           <tr> <td  colspan=6 height="1" style="border-top: 1px solid #000000; border-bottom: 0px solid #000000;" align="left"> <c:out value="${lista.sede}"/> :: </td>
           </tr>   
           <c:set var="concepto" value="${lista.sede}"/>		   
           <c:set var="id_concepto" value="${lista.sede}"/>          
  ...
  <tr>
     <td colspan=3 height="1" style="border-top: 1px solid #000000; border-bottom: 2px solid #000000;" align="right">SubTotales&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td  height="1" style="border-top: 1px solid #000000; border-bottom: 2px solid #000000;" align="right"> <c:out value="${subtotal}"/> </td>
	 <td  height="1" style="border-top: 1px solid #000000; border-bottom: 2px solid #000000;" align="right"> <c:out value="${subdescuento}"/> </td>
...
<table width="100%"  class="tabla" style="border-top: 2px solid #000000;border-bottom: 2px solid #000000;">
<tr>
<th class='etiqueta' align="center"><div class="clave" align="left">TOTAL ENTREGADO FUL (Centro Facultativo+Centro de Carrera+Centro de Comensales+FUL)   </th>
<th class='etiqueta'><c:out value="${pagado}"/></th>
