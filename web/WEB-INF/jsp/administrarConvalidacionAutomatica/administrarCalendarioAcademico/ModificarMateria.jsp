...
<form name="forma" action="registrarMateria.fautapo" method="post">
  <table class="formulario">
        ...
        <select name="id_tipo_materia">
          <option value="0">-- seleccione --
            <c:forEach var="lista" items="${lTiposMaterias}">
              <option value="<c:out value="${lista.id_tipo_materia}"/>" <c:if test="${lista.id_tipo_materia==datosMateria.id_tipo_materia}">selected</c:if>>
    ...
    <tr>
      ...
      <td class="etiqueta">::</td>	      
      <td><input type="text" name="materia" value='<c:out value="${datosMateria.materia}"/>'>
      </td>
    </tr>
    <tr>
      <td class="etiqueta">Sigla <font color='red'>(*)</font> </td>
      <td class="etiqueta">::</td>	      
      <td><input type="text" name="sigla" value='<c:out value="${datosMateria.sigla}"/>'>
      </td>
    </tr>
    <tr>
      <td class="etiqueta">Hrs. Te&oacute;ricas <font color='red'>(*)</font> </td>
      <td class="etiqueta">::</td>	      
      <td><input type="text" name="hrs_teoricas" value='<c:out value="${datosMateria.hrs_teoricas}"/>'>
      </td>
    </tr>
    <tr>
      <td class="etiqueta">Hrs. Pr&aacute;cticas <font color='red'>(*)</font> </td>
      <td class="etiqueta">::</td>	      
      <td><input type="text" name="hrs_practicas" value='<c:out value="${datosMateria.hrs_practicas}"/>'>
      </td>
    </tr>
    <tr>
      <td class="etiqueta">Hrs. Periodo <font color='red'>(*)</font> </td>
      <td class="etiqueta">::</td>	      
      <td><input type="text" name="hrs_periodo" value='<c:out value="${datosMateria.hrs_periodo}"/>'></td>
    </tr>
    <tr>
      <td class="etiqueta">Cr&eacute;ditos <font color='red'>(*)</font> </td>
      <td class="etiqueta">::</td>	      
      <td><input type="text" name="creditos" value='<c:out value="${datosMateria.creditos}"/>'></td>
    </tr>
  </table>
  <center>
