    ...
    <body>
        ...
        <table class="tabla">
            <tr>
                ...
                <th>Programa</th>
                <td class="colb"><c:out value="${programa.programa}"/>
            </tr>
        </table>
        <br>
        <form name="forma" method="post" action="<c:url value="registrarSedeProgramaEstudiante.fautapo"/>">
            ...
            <table class="formulario">  
                ...
                <tr>
                    ...
                    <td class="etiqueta">::<font color='red'>(*)</font></td>
                    <td><textarea  id="numb" class="form-control" name="nota" rows="3" ></textarea></td>
                </tr>
            </table>
            <center>
                <input    type="submit" value="Siguiente" class="siguiente" onClick="fguardar()">
            </center>
        </form>
    </body>
    <script>
        <script>
        var lProgramasDesconcentrado =${lProgramasFacDescocentrados};
            var idDesconcentrado=${id_desconcentrado};
                console.log(lProgramasDesconcentrado);
                const fguardar = () => {
        ...
        const init = () => {
        document.getElementById('id_desconcentrado').innerHTML = optionscollectioncomplete(lProgramasDesconcentrado, idDesconcentrado, - 1);
        }
    </script>
