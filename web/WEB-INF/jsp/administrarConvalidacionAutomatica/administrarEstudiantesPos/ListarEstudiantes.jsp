...
<div class="centro">
  ...
  <c:forEach var="lista" items="${lEstPersonas}" varStatus="contador">
	...
	<c:if test="${lista.id_estado == 'B'}"> <font color="red"> Bloqueado </font></c:if>
      ...
      <td>
        <form name="fmodificar<c:out value='${contador.count}'/>_<c:out value='${contadorA.count}'/>" action="<c:url value='/est_personaspos/listarEstudiantes.fautapo'/>" method="post">
