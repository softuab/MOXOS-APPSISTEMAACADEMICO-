...
<div class="titulo">Controlar Asistencia de Postulante P.S.A.</div>
<br>
<form name="fvolver" action="<c:url value='/buscarPstpsa/listarPostulantes.fautapo'/>" method="post">
...
<br>
<form  name=forma action="<c:url value="/buscarPstpsa/habilitarPostulante.fautapo"/>" method="POST">
  <table class="tabla">
    <tr>
      <th colspan="7"> CONFIRMAR CONTROL</th>
    </tr>  
    <tr>
      <th>?</th>
      <th>Nro.</th>
