...
<table width="100%">
  ...
  <tr>
    ...
    <table width="100%" align="center">
      <tr>
        <td align="center"><label><h2>LISTA DE TRANSACCIONES - ENTIDADES FINANCIERAS </h2></label></td>
      </tr>
	  <tr>
    ...
    <td>
      ...
      <table class="tabla" width="100%">
        ...
        <c:forEach var="lista" items="${lTransacciones}" varStatus="contador">
		  ...
		  <tr>
           <td colspan=6 height="1" style="border-top: 2px solid #000000; border-bottom: 2px solid #000000;" align="right">TOTAL&nbsp;&nbsp;&nbsp;&nbsp;</td>
