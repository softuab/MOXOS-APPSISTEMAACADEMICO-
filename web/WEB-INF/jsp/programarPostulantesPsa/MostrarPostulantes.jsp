...
<br>
<form name="fvolver" action="<c:url value='/habilitarPstpsa/listarPostulantes.fautapo'/>" method="post">
...
<br>
<form  name=forma action="<c:url value="/habilitarPstpsa/habilitarPostulante.fautapo"/>" method="POST">
  <table class="tabla">
    <tr>
