...
<div class="titulo">Reporte de pendientes agrupados </div>
<br>
<form name="forma" method="post">
  <table class="formulario" align="letf">
    <tr>
      <th>Funcionario</th>
      <td>
        <SELECT name="id_usuario" onchange="javascript:document.forma.submit();">
          <option value="0">-- Seleccione --</option>
          <c:forEach var="lista" items="${lUsuarios}" >
...
<table class="tabla">
  ...
  <tr onMouseOver="this.className='sobreFila'" onmouseout="this.className=''">
    ...
    <td align="center">
      <form name=pendientesActivosAntes  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado.fautapo"/>' >
    ...
    <td align="center">
      <form name=pendientesActivosSemana  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado.fautapo"/>' >
        <input type=hidden name="id_estado"            value='A' >
    ...
    <td align="center">
      <form name=pendientesActivosHoy  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado.fautapo"/>' >
        <input type=hidden name="id_estado"           value='A' >
  ...
  <tr onMouseOver="this.className='sobreFila'" onmouseout="this.className=''">
    ...
    <td align="center">
      <form name=pendientesBloqueadosAntes  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado.fautapo"/>' >
    ...
    <td align="center">
       <form name=pendientesBloqueadosSemana  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado.fautapo"/>' >
        <input type=hidden name="id_estado"            value='B' >
        <input type=hidden name="fechainicio"          value='<fmt:formatDate value="${fechadellunes}" pattern="${formatoFecha}"/>' >      
        <input type=hidden name="fechafin"             value='<fmt:formatDate value="${fechahoy}" pattern="${formatoFecha}"/>' >       
        <input type=hidden name="aplicacion" value='<c:url value="/"/>' >
    ...
    <td align="center">
       <form name=pendientesBloqueadosHoy  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado.fautapo"/>' >
         <input type=hidden name="id_estado"           value='B' >
         <input type=hidden name="fechainicio"         value='<fmt:formatDate value="${fechahoy}" pattern="${formatoFecha}"/>' >      
         <input type=hidden name="fechafin"            value='<fmt:formatDate value="${fechamaniana}" pattern="${formatoFecha}"/>'>       
         <input type=hidden name="aplicacion" value='<c:url value="/"/>' >
  ...
  <tr bgColor="#FFFFD9" onMouseOver="this.className='sobreFila'" onmouseout="this.className=''">
    ...
    <td align="center">
       <form name=pendientesPorRecibirAntes  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado.fautapo"/>' >
    ...
    <td align="center">
       <form name=pendientesPorRecibirSemana  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado.fautapo"/>' >
        <input type=hidden name="id_estado"            value='P' >
        <input type=hidden name="fechainicio"          value='<fmt:formatDate value="${fechadellunes}" pattern="${formatoFecha}"/>' >      
        <input type=hidden name="fechafin"             value='<fmt:formatDate value="${fechahoy}" pattern="${formatoFecha}"/>' >       
        <input type=hidden name="aplicacion" value='<c:url value="/"/>' >
    ...
    <td align="center">
      <form name=pendientesPorRecibirHoy  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado.fautapo"/>' >
         <input type=hidden name="id_estado"           value='P' >
         <input type=hidden name="fechainicio"         value='<fmt:formatDate value="${fechahoy}" pattern="${formatoFecha}"/>' >      
         <input type=hidden name="fechafin"            value='<fmt:formatDate value="${fechamaniana}" pattern="${formatoFecha}"/>'>       
         <input type=hidden name="aplicacion" value='<c:url value="/"/>' >
  ...
  <tr onMouseOver="this.className='sobreFila'" onmouseout="this.className=''">
    ...
    <td align="center">
      <form name=pendientesDespachadosAntes  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado2.fautapo"/>' >
        <input type=hidden name="id_estado"      value='P' >
        <input type=hidden name="id_usuario"     value='<c:out value="${id_usuario}"/>' >
        <input type=hidden name="fechadellunes"  value='<fmt:formatDate value="${fechadellunes}" pattern="${formatoFecha}"/>' >       
        <input type=hidden name="aplicacion"     value='<c:url value="/"/>' >
    ...
    <td align="center">
       <form name=pendientesDespachadosSemana  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado2.fautapo"/>' >
        <input type=hidden name="id_estado"      value='P' >
        <input type=hidden name="id_usuario"     value='<c:out value="${id_usuario}"/>' >
        <input type=hidden name="fechainicio"    value='<fmt:formatDate value="${fechadellunes}" pattern="${formatoFecha}"/>' >      
        <input type=hidden name="fechafin"       value='<fmt:formatDate value="${fechahoy}" pattern="${formatoFecha}"/>' >       
    ...
    <td align="center">
       <form name=pendientesDespachadosHoy method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado2.fautapo"/>' >
         <input type=hidden name="id_estado"     value='P' >
         <input type=hidden name="id_usuario"    value='<c:out value="${id_usuario}"/>' >
         <input type=hidden name="fechainicio"   value='<fmt:formatDate value="${fechahoy}" pattern="${formatoFecha}"/>' >      
         <input type=hidden name="fechafin"      value='<fmt:formatDate value="${fechamaniana}" pattern="${formatoFecha}"/>'>       
  ...
  <tr onMouseOver="this.className='sobreFila'" onmouseout="this.className=''">
    ...
    <td align="center">
      <form name=pendientesConfirmadosAntes  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado2.fautapo"/>' >
        <input type=hidden name="id_estado"      value='A' >
        <input type=hidden name="id_usuario"     value='<c:out value="${id_usuario}"/>' >
        <input type=hidden name="fechadellunes"  value='<fmt:formatDate value="${fechadellunes}" pattern="${formatoFecha}"/>' >       
        <input type=hidden name="aplicacion"     value='<c:url value="/"/>' >
    ...
    <td align="center">
       <form name=pendientesConfirmadosSemana  method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado2.fautapo"/>' >
        <input type=hidden name="id_estado"   value='A' >
        <input type=hidden name="id_usuario"  value='<c:out value="${id_usuario}"/>' >
        <input type=hidden name="fechainicio" value='<fmt:formatDate value="${fechadellunes}" pattern="${formatoFecha}"/>' >      
        <input type=hidden name="fechafin"    value='<fmt:formatDate value="${fechahoy}" pattern="${formatoFecha}"/>' >       
    ...
    <td align="center">
       <form name=pendientesConfirmadosHoy method="POST" action='<c:url value="/listarReportePendientesAgrupadosPorEstado2.fautapo"/>' >
         <input type=hidden name="id_estado"   value='A' >
         <input type=hidden name="id_usuario"  value='<c:out value="${id_usuario}"/>' >
         <input type=hidden name="fechainicio" value='<fmt:formatDate value="${fechahoy}" pattern="${formatoFecha}"/>' >      
         <input type=hidden name="fechafin"    value='<fmt:formatDate value="${fechamaniana}" pattern="${formatoFecha}"/>'>       
