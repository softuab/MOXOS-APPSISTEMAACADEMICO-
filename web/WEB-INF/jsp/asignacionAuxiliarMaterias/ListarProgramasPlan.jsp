...
<br>
<tabla>
  <form name=formavolver<c:out value="${contador.count}"/> method=post action='<c:url value="/auxiliares/verProgramaPlanAsignacion.fautapo"/>'>
    <td>
...
<br>
<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/auxiliares/listarMateriasProgramaPlan.fautapo"/>'>
  <input type="hidden" name="gestion" value='<c:out value="${gestion}"/>' >
  <input type="hidden" name="periodo" value='<c:out value="${periodo}"/>' >
