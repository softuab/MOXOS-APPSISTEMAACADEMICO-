...
<html lang="es">
    ...
    <body>
        ...
        <br>
        <form id="forma" action="<c:url value='//estudiante/cambioaula/registarCambio.fautapo'/>" method="get">
            <table class="formulario" aria-describedby="entrada ver datos">
                <thead>
                    <tr>
                        <th colspan="3"> CAMBIO DE AULA </th>
                    </tr> 
                </thead>
                <tbody>
                    <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8">
                                            <select id='id_tipo_evaluacion' name='id_tipo_evaluacion'>
                                                ...
                                                <c:forEach var="item" items="${lTiposEvaluaciones}" >
                                                    <option value='${item.id}' class='upper'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8">
                                            <select id='id_desconcentrado' name='id_desconcentrado'>
                                                <option value="-1">-- Seleccione --</option>
                                                <c:forEach var="item" items="${lDesconcentrado}" >
                    ...
                    <tr>
                        <td>
                            <button onClick="enviarSolicitud('forma')" type='button' id="btnenviar"  role="button"  class="btn">Registrar cambio</button> 
                        </td>
                    </tr>
                </tbody>
            </table>
