...
<html lang="es">
    ...
    <body>
        ...
        <br>
        <form id="forma" action="<c:url value='/estudianteNuevo/listarPostulantes.fautapo'/>" method="post"> 
            <table class="formulario" aria-describedby="entrada ver datos">
                <thead>
                    <tr>
                        <th colspan="3"> BUSCAR ESTUDIANTE -POSTULANTE </th>
                    </tr> 
                </thead>
                <tbody>
                    <tr> 
                        <td colspan="3">
                            <div class="container-grid">
                                <div class="row">
                                    <div class="col-xs-4">
                                        Gesti&oacute;n de Matriculaci&oacute;n <span class="obligatorio">(*)</span>
                                    </div>
                                    <div class="col-xs-8">
                                ...
                                <div class="row">
                                    <div class="col-xs-4">
                                        Periodo de Matriculaci&oacute;n <span class="obligatorio">(*)</span>
                                    </div>
                                    <div class="col-xs-8">
                                ...
                                <div class="row">
                                    <div class="col-xs-4">
                                        Tipo Admisi&oacute;n <span class="obligatorio">(*)</span>
                                    </div>
                                    <div class="col-xs-8"> 
                        ...
                        <td colspan="3">
                            ...
                            <fieldset>
                                ...
                                <div class="grid-fieldset">
                                    ...
                                    <input type=submit name="botonDip" value='Buscar carnet' onClick="enviarSolicitud('forma')" class="buscar"> 
                                    <label style="text-align: right"><strong>Nombres ::</strong></label>
                                    <input type=text name="nombre" value="${nombre}">
                                    <input type=submit name="botonNombre" value='Buscar nombre' class="buscar" onClick="enviarSolicitud('forma')">
                                </div>
