...
<form name="forma" action="<c:url value="/listarInformesProcesoPstPersona.fautapo"/>" method="POST">
  <table class="formulario">
    ...
    <tr>
      ...
      <td>
        <c:out value="${datosPstPersona.nombres}"/> &nbsp; 
        <c:out value="${datosPstPersona.paterno}"/> &nbsp;
        <c:out value="${datosPstPersona.materno}"/>
      </td>
    </tr>
    <tr>
      <td class="etiqueta" align="right">C.I.</td>
      <td class="etiqueta">::</td>
      <td><c:out value="${datosPstPersona.dip}"/>
    </tr>
    <tr>
      <td class="etiqueta" align="right">Fecha de Nac.</td>
      <td class="etiqueta">::</td>
      <td><c:out value="${datosPstPersona.fec_nacimiento}"/>
    </tr>
    <tr>
      <td class="etiqueta" align="right">Direcci&oacute;n</td>
      <td class="etiqueta">::</td>
      <td><c:out value="${datosPstPersona.direccion}"/>
    </tr>
    <tr>
      <td class="etiqueta" align="right">Tel&eacute;fono</td>
      <td class="etiqueta">::</td>
      <td><c:out value="${datosPstPersona.telefono}"/>
    </tr>
