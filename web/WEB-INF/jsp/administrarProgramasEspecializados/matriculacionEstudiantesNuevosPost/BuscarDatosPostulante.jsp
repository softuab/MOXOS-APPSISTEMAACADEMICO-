                                    ...
                                    <tr>
                                        <td>
                                            <div class="group-form">
                                                ...
                                                <input type="text" name="paterno" onkeyup="fmayus();" style="background-color:pink" value="<c:out value='${bPst.paterno}'/>" readonly />
                                            </div>
                                        </td>	
                                        <td >
                                            <div class="group-form">
                                                <label>2do. Apellido</label>
                                                <input type="text" name="materno" onkeyup="fmayus();" style="background-color:pink" value="<c:out value='${bPst.materno}'/>" readonly />
                                            </div>
                                        </td>	
                                        <td>
                                            <div class="group-form">
