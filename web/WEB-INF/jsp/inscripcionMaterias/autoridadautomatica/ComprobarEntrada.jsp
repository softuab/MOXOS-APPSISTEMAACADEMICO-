...
<div class="titulo">Innscripci&oacute;n de materias</div>
<div class="volver"><a href="javascript:history.back();">Volver</a></div>

<body onLoad='iniciar()'>
<form name='forma' method="post" action='<c:url value="/inscripcionMateriasAutomatica/comprobarEntrada.fautapo"/>'>
