...
<form method=post action=<c:url value="/inscripcionMateriasEstudianteHorarios/confirmarProgramacionMaterias.fautapo"/> >
...
<tr>
  <td colspan="6" align="center"><input class="aceptar" type="submit" value="Aceptar"></td>
</table>
