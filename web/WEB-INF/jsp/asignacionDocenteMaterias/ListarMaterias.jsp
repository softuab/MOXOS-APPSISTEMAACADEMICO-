...
<div class="titulo">Asignacion Docente Materias-Carreras</div>
...
<!-- <c:if test="${iResultadoFaseResolucion == 0}" >  -->
	<form name='formaFases<c:out value="${contador.count}"/>' method=post action='<c:url value="/avanzarFaseDesignacion.fautapo"/>'>
         <td> 
