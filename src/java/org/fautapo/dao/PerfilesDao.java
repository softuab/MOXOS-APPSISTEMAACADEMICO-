...
public interface PerfilesDao {
    ...
    Perfiles getTrnBuscarTransaccionReciboSedePerfil(Perfiles perfil) throws DataAccessException;

    List<Perfiles> getTrnBuscarTransaccionReciboSedePerfiles(Perfiles perfil) throws DataAccessException;
