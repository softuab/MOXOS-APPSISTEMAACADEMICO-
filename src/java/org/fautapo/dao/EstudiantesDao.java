...
public interface EstudiantesDao {
    ...
    Estudiantes getEstBuscarEstudianteNombresSedePostgrado(Estudiantes estudiante) throws DataAccessException;
...
//INICIO - METODOS ADICIONADOS POR LA UAP
    ...
    //LISTAR ESTUDIANTES PROGRAMAS SEDE

    //LISTAR ESTUDIANTES PROGRAMAS SEDE
    Estudiantes getListarEstudiantesProgramasSede(Estudiantes estudiante) throws DataAccessException;

    List getListarFclProgramasDescocentrado(int id_programa) throws DataAccessException;

    int setRegistrarEstudiantes_programas_sede(Estudiantes estudiante) throws DataAccessException;

    Estudiantes getDetalleEstudiantesProgramaSede(int id_estudiante_programa_sede) throws DataAccessException;

    int setModificarProgramaDesconcentrado(Estudiantes estudiantes) throws DataAccessException;

    int setEliminarProgramaDesconcentrado(Estudiantes estudiantes) throws DataAccessException;

    List getVerProgramasFaseDesconcentrado(int id_estudiante) throws DataAccessException;

    Estudiantes getMostraSedeDesconcentrada(int id_desconcentrado) throws DataAccessException;

    int setActualizarIdDesconcentradoEstudiantes(Estudiantes estudiantes) throws DataAccessException;

    Estudiantes getDatosImpresionAfp(int id_estudiante) throws DataAccessException;

    void RegistrarCsmbioAulaProgramacion(Estudiantes estudiantes) throws DataAccessException;
}
