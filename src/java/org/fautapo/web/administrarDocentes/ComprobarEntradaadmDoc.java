...
public class ComprobarEntradaadmDoc implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    System.out.println("EL DIP -->"+sDip);
    System.out.println("EL Nombre -->"+sNombre);
    ...
    if ((sDip == null) && (sNombre == null)) {
      ...
      if (null == this.mi.getComprobarUsuario(usuario)) {
        ...
        return new ModelAndView("administrarDocentes/Error", modelo);
      }
    }  
    modelo.put("dip", sDip);
