...
public class EntradaCurriculumDocente implements Controller 
{
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception 
  {
    ...
    return new ModelAndView("administrarCurriculumDocente/EntradaCurriculumDocente", modelo); //enviar modelo a jsp
   }
}