package org.fautapo.web.asignacionMateriasGrupos;
...
public class ListarProgramasPlanGrupo implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (null == this.mi.getComprobarUsuario(usuario)) {
      return new ModelAndView("verPlanEstudios/Entrada", "cliente", cliente);
    }
    ...
    return new ModelAndView("asignacionMateriasGrupos/ListarProgramasPlan", modelo);
  }
}