...
package org.fautapo.web.reportesEspecializadosTesoreria.totalDetalladoMatriculasProvincias;
...
public class FormarReporteTesoreriaTotalMatri implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasResumenDetalladoMatriculasGlobalProv(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosTesoreria/totalDetalladoMatriculasProvincias/FormarReporte", modelo);
  }
}
