...
package org.fautapo.web.reportesEspecializadosTesoreria.transaccionesDiarias;
...
public class FormarReporteRepEs implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasTransaccionesDetalleGlobal(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosTesoreria/transaccionesDiarias/FormarReporte", modelo);
  }
}
