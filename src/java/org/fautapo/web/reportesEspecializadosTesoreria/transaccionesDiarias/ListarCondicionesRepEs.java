...
public class ListarCondicionesRepEs implements Controller {
  private MiFacade mi;
...
//    f.combo_cuenta_bancaria();
    ...
    return new ModelAndView("reportesEspecializadosTesoreria/transaccionesDiarias/ListarCondiciones", modelo);
  }
}