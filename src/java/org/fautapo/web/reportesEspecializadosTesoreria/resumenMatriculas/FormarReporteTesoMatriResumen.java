...
package org.fautapo.web.reportesEspecializadosTesoreria.resumenMatriculas;
...
public class FormarReporteTesoMatriResumen implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasResumenMatriculasGlobal(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosTesoreria/resumenMatriculas/FormarReporte", modelo);
  }
}
