package org.fautapo.web.reportesEspecializadosTesoreria.aportesInstitucionales;
...
public class FormarReporteTesoInstitu implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List lTransacciones = this.mi.getRepCajasResumenInstitucionalGlobal(datosTransaccion);
        ...
        return new ModelAndView("reportesEspecializadosTesoreria/aportesInstitucionales/FormarReporte", modelo);
    }
}
