...
*****************************************/
package org.fautapo.web.reportesEspecializadosTesoreria.aportesEstudiantilesProvincias;
...
public class FormarReporteAportesProvEstudiantiles implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	List lTransacciones = this.mi.getRepCajasResumenEstudiantilGlobalProv(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosTesoreria/aportesEstudiantilesProvincias/FormarReporte", modelo);
  }
}
