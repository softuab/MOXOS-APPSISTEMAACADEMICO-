...
package org.fautapo.web.reportesEspecializadosTesoreria.porConceptosxCajero;
...
public class FormarReporteporConceptoxCajero implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasTransaccionesDiariasGlobalxcajero(datosTransaccion);
 ...
 //	String id_usuario = cliente.getNombres();
    ...
    return new ModelAndView("reportesEspecializadosTesoreria/porConceptosxCajero/FormarReporte", modelo);
  }
}
