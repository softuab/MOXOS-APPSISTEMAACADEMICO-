...
public class ListarCondicionesTranAnu implements Controller {
  private MiFacade mi;
...
//    f.combo_cuenta_bancaria();
    ...
    return new ModelAndView("reportesEspecializadosTesoreria/transaccionesAnuladas/ListarCondiciones", modelo);
  }
}