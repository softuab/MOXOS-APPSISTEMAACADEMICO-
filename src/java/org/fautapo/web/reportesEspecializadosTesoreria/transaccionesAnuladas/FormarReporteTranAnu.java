...
*****************************************/
package org.fautapo.web.reportesEspecializadosTesoreria.transaccionesAnuladas;
...
public class FormarReporteTranAnu implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasTransaccionesDetalleGlobalAnuladas(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosTesoreria/transaccionesAnuladas/FormarReporte", modelo);
  }
}
