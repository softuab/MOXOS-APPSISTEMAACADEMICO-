...
*****************************************/
package org.fautapo.web.reportesEspecializadosTesoreria.transaccionesDiariasProvincias;
...
public class FormarReporteRepPro implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasTransaccionesDetalleGlobalProv(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosTesoreria/transaccionesDiariasProvincias/FormarReporte", modelo);
  }
}
