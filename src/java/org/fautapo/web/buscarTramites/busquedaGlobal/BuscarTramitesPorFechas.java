...
public class BuscarTramitesPorFechas implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	datosTramite.setId_ubicacion_organica(iId_ubicacion_organica);
    ...
    modelo.put("id_ubicacion_organica", Integer.toString(iId_ubicacion_organica));
    
    return new ModelAndView("buscarTramites/busquedaGlobal/BuscarTramitesPorFechas", modelo);
  } 
}