...
public class EntradaDibRap2 implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (sPermiso.indexOf("c") > -1) {
      return new ModelAndView("dibRapFiltrado/Entrada", modelo);
    }
    sPermiso = sPermiso + "&f=";
    ...
    return new ModelAndView("Distro", "url", "/dibRapFiltrado/listarDatos.fautapo?t=" + sId_tabla + "&e=" + sId_enlace + "&p=" + sPermiso);
  }
}