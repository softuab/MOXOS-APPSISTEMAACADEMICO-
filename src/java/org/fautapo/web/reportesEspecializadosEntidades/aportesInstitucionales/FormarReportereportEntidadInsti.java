package org.fautapo.web.reportesEspecializadosEntidades.aportesInstitucionales;
...
public class FormarReportereportEntidadInsti implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List lTransacciones = this.mi.getRepCajasResumenInstitucionalEntidades(datosTransaccion);
        ...
        return new ModelAndView("reportesEspecializadosEntidades/aportesInstitucionales/FormarReporte", modelo);
    }
}
