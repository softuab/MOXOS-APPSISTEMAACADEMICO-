...
package org.fautapo.web.reportesEspecializadosEntidades.detalladoProFacultativoPorCarrera;
...
public class FormarReporteDetallxCarrera implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasResumenProfactulativoCarrera(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosEntidades/detalladoProFacultativoPorCarrera/FormarReporte", modelo);
  }
}