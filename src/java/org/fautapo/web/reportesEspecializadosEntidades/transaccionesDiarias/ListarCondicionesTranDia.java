...
public class ListarCondicionesTranDia implements Controller {
  private MiFacade mi;
...
//    f.combo_cuenta_bancaria();
    ...
    return new ModelAndView("reportesEspecializadosEntidades/transaccionesDiarias/ListarCondiciones", modelo);
  }
}