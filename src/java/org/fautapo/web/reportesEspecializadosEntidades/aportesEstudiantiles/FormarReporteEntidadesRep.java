...
****************************************
 */
package org.fautapo.web.reportesEspecializadosEntidades.aportesEstudiantiles;
...
public class FormarReporteEntidadesRep implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List lTransacciones = this.mi.getRepCajasResumenEstudiantilEntidades(datosTransaccion);
        ...
        return new ModelAndView("reportesEspecializadosEntidades/aportesEstudiantiles/FormarReporte", modelo);
    }
}
