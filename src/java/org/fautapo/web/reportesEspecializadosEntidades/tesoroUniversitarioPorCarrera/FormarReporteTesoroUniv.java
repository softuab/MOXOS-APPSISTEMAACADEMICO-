...
package org.fautapo.web.reportesEspecializadosEntidades.tesoroUniversitarioPorCarrera;
...
public class FormarReporteTesoroUniv implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasResumenTesoroCarrera(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosEntidades/tesoroUniversitarioPorCarrera/FormarReporte", modelo);
  }
}
