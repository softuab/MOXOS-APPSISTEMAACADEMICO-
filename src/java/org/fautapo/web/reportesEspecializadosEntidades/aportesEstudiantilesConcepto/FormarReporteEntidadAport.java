...
package org.fautapo.web.reportesEspecializadosEntidades.aportesEstudiantilesConcepto;
...
public class FormarReporteEntidadAport implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	List lTransacciones = this.mi.getRepCajasResumenEstudiantilEntidadesConcepto(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosEntidades/aportesEstudiantilesConcepto/FormarReporte", modelo);
  }
}
