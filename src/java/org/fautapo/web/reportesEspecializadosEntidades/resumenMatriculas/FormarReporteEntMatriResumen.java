...
package org.fautapo.web.reportesEspecializadosEntidades.resumenMatriculas;
...
public class FormarReporteEntMatriResumen implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasResumenTesoroEntidades(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializadosEntidades/resumenMatriculas/FormarReporte", modelo);
  }
}
