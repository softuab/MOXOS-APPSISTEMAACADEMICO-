...
****************************************
 */
package org.fautapo.web.reportesEspecializadosEntidades.aportesInstitucionalesConcepto;
...
public class FormarReporteEntidadConcept implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List lTransacciones = this.mi.getRepCajasResumenInstitucionalEntidadesConcepto(datosTransaccion);
        ...
        return new ModelAndView("reportesEspecializadosEntidades/aportesInstitucionalesConcepto/FormarReporte", modelo);
    }
}
