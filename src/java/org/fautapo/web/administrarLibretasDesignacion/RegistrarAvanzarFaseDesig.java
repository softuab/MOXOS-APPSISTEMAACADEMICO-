...
public class RegistrarAvanzarFaseDesig implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    datosAsignacion = this.mi.getDctBuscarAsignacionDocenteDesignacion(datosAsignacion);
    ...
    */
    if ("Avanzar >>".equals(sAccion)) {
      ...
      System.out.println("El ID_FASE en AVANZAR ES -->"+ Integer.toString(avanzar.getId_fase()));
      ...
      System.out.println("El id_docente -->"+ Integer.toString(avanzar.getId_docente()));
      System.out.println("El id_departamento -->"+ Integer.toString(avanzar.getId_departamento()));
      System.out.println("El id_materia -->"+ Integer.toString(avanzar.getId_materia()));
      System.out.println("El id_grupo -->"+ Integer.toString(avanzar.getId_grupo()));
      System.out.println("El id_modelo_ahorro -->"+ Integer.toString(avanzar.getId_modelo_ahorro()));	
      System.out.println("El id_tipo_evaluacion -->"+ Integer.toString(avanzar.getId_tipo_evaluacion()));
      System.out.println("El gestion -->"+ Integer.toString(avanzar.getGestion()));
      System.out.println("El periodo -->"+ Integer.toString(avanzar.getPeriodo()));
      System.out.println("El id_fase -->"+ Integer.toString(avanzar.getId_fase()));
      System.out.println("El id_tipo_grado -->"+ Integer.toString(avanzar.getId_tipo_grado()));
      System.out.println("El id_rol -->"+ Integer.toString(avanzar.getId_rol()));
      System.out.println("El ul_usuario -->"+ Integer.toString(avanzar.getUlt_usuario()));
    ...
    return new ModelAndView("administrarLibretasDesignacion/SalidaRegistrarAvanzarFase", modelo);
  }
}