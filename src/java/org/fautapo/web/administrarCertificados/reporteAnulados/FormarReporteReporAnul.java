...
public class FormarReporteReporAnul implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	System.out.println("ANTES");
      ...
      List lDatosAnuladosCertificados = this.mi.getListarCertGenAnulados(datosAnu);
    ...
    return new ModelAndView("administrarCertificados/reporteAnulados/FormarReporte", modelo);
  }
}