...
public class ListarCondicionesproDeta implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return new ModelAndView("reportesEspecializados/detalladoProFacultativo/ListarCondiciones", modelo);
    }
}
