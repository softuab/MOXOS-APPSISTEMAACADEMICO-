...
****************************************
 */
package org.fautapo.web.reportesEspecializados.porCajeroPerfilesProvincias;
...
public class FormarReporteperfProv implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        sql += "\n FROM transacciones t INNER JOIN trn_perfiles p USING(id_perfil) WHERE t.id_estado = 'A' AND t.cajero = " + f.sRequest("id_usuario");
        sql += "\n and t.id_sede != 1";
        ...
        return new ModelAndView("reportesEspecializados/porCajeroPerfilesProvincias/FormarReporte", modelo);
    }
}
