...
package org.fautapo.web.reportesEspecializados.aportesEstudiantiles;
...
public class FormarReporteAportesEstudian implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	List lTransacciones = this.mi.getRepCajasResumenEstudiantil(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializados/aportesEstudiantiles/FormarReporte", modelo);
  }
}
