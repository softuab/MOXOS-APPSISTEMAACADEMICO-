...
public class ListarCondicionesPorConceptoCaje implements Controller {
  private MiFacade mi;
...
//    f.combo_cuenta_bancaria();
    ...
    return new ModelAndView("reportesEspecializados/porConceptosCajeros/ListarCondiciones", modelo);
  }
}