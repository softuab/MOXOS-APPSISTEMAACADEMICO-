package org.fautapo.web.reportesEspecializados.transaccionesDiarias;
...
public class FormarReporte implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List lTransacciones = this.mi.getRepCajasTransaccionesDetalle(datosTransaccion);
        ...
        return new ModelAndView("reportesEspecializados/transaccionesDiarias/FormarReporte", modelo);
    }
}
