...
public class FormarReporteInstitu implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List lTransacciones = this.mi.getRepCajasResumenInstitucional(datosTransaccion);
        ...
        return new ModelAndView("reportesEspecializados/aportesInstitucionales/FormarReporte", modelo);
    }
}
