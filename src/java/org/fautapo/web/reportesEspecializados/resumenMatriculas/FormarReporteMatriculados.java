...
package org.fautapo.web.reportesEspecializados.resumenMatriculas;
...
public class FormarReporteMatriculados implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasResumenMatriculas(datosTransaccion);
    ...
    return new ModelAndView("reportesEspecializados/resumenMatriculas/FormarReporte", modelo);
  }
}
