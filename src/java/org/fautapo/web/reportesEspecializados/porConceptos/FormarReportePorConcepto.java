...
*****************************************/
package org.fautapo.web.reportesEspecializados.porConceptos;
...
public class FormarReportePorConcepto implements Controller {
  private MiFacade mi;
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lTransacciones = this.mi.getRepCajasTransaccionesDiarias(datosTransaccion);
 ...
 //	String id_usuario = cliente.getNombres();
    ...
    return new ModelAndView("reportesEspecializados/porConceptos/FormarReporte", modelo);
  }
}
