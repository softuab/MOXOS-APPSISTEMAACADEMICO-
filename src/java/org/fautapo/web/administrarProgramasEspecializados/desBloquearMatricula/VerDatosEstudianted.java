...
public class VerDatosEstudianted implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    return new ModelAndView("administrarProgramasEspecializados/desBloquearMatricula/VerDatosEstudiante", modelo);
  }
}
