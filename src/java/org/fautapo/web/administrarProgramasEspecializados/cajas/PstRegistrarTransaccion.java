 ...
 */
public class PstRegistrarTransaccion implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        ///postulante.setId_programa(1);
        //    postulante.setId_plan("1");
        postulante.setId_estado("P");
        ...
        for (int i = 0; i < sPerfiles_procesos.length; i++) {
            ...
            transaccion.setId_postulante(iId_postulante);
            transaccion.setId_persona(postulante.getId_persona());
            transaccion.setId_programa(postulante.getId_programa());
            ...
            List listaConceptos = this.mi.getPstListarConceptos(transaccion);
            if (iResultado > 0) {
        ...
        return new ModelAndView("administrarProgramasEspecializados/cajas/PstListarConceptosImpresion", modelo);
    }
}
