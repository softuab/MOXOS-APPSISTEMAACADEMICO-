 ...
 */
public class DctRegistrarTransaccion implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        int iId_docente = Integer.parseInt(tramite.getValores());
        ...
        for (int i = 0; i < sPerfiles_procesos.length; i++) {
            ...
            transaccion.setId_persona(docente.getId_persona());
            ...
            List listaConceptos = this.mi.getDctListarConceptos(transaccion);
            if (iResultado > 0) {
        ...
        return new ModelAndView("administrarProgramasEspecializados/cajas/DctListarConceptosImpresion", modelo);
    }
}
