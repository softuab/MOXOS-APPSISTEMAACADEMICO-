 ...
 */
public class PrsDocRegistrarTransaccion implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        //Sacamos los datos para la actualizacion del RECIBO
        if (lDetalles.size() > 0) {
        ...
        return new ModelAndView("administrarProgramasEspecializados/cajas/PrsDocListarConceptosImpresion", modelo);
    }
}
