 ...
 */
public class RegistrarPersonaEstudianteNuev implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String sIdPlan = datosPlan.getId_plan();
        ...
        if ((!"".equals(sIdPlan)) && (sIdPlan != null) && (!"".equals(sIdPrograma)) && (sIdPrograma != null) && (!"".equals(sIdTipoAdmision)) && (!"".equals(sIdTipoGrado))
            ...
            if (iIdPersonaResultado != 0) {
                datosP.setId_persona(iIdPersonaResultado);
            ...
            datosEst.setId_persona(iIdPersonaResultado);
            datosEst.setId_programa(Integer.parseInt(sIdPrograma));
            datosEst.setId_plan(sIdPlan);
            ...
            if (iIdEstudianteResultado > 0) {
                ...
                datoPst.setId_postulante(iIdPostulante);
