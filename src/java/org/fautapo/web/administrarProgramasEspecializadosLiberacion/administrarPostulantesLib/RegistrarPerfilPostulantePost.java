 ...
 */
public class RegistrarPerfilPostulantePost implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String sIdPerfilProceso_p[] = request.getParameterValues("id_perfil_proceso_p");
        String sIdPerfilProceso = "";

        if (sIdPerfilProceso_p != null) {
            ...
            for (int i = 0; i < sIdPerfilProceso_p.length; i++) {
                if (i == 0) {
                    sIdPerfilProceso += sIdPerfilProceso_p[i];
                } else {
                    sIdPerfilProceso += ":" + sIdPerfilProceso_p[i];
                }
            }
        ...
        modelo.put("qr", image);
        return new ModelAndView("administrarProgramasEspecializadosLiberacion/administrarPostulantesLib/ImprimirDatosPostulante", modelo);
