...
public class BuscarTramiteAnular implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (("Buscar".equals(sAccion)) && (!"".equals(sCorrelativo)) && (sCorrelativo != null)) {
	  ...
	  datosTramite = new Tramites();
	    ...
	    return new ModelAndView("anularTramites/ListarTramitesParalelos", modelo);
	  }
	  ...
	  iId_tramite = Integer.parseInt(sId_tramite);
      	...
      	return new ModelAndView("anularTramites/BuscarTramite", modelo);
      }
	...
	return new ModelAndView("Error", "mensaje", "Este proceso no se puede anular ya que est� bloqueado");
      }
