...
public class ListarAsignacionesDocentesProgramaCalAca implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        modelo.put("periodo", sPeriodo);
        //modelo.put("id_tipo_evaluacion",iId_tipo_evaluacion);
        ...
        if ((!"".equals(sId_programa))) {
            ...
            datosCA.setId_tipo_evaluacion(iId_tipo_evaluacion);
        ...
        return new ModelAndView("reportesAcademicos/verCalendarioAcademicoDocente/ListarAsignacionesDocentesPrograma", modelo);
    }
}
