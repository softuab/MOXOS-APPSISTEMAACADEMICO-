...
public class ListarProgramasPlanesNivel implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (null == this.mi.getComprobarUsuario(usuario)) {
      return new ModelAndView("reportesAcademicos/imprimirCertificadoNotasNivel/Entrada", "cliente", cliente);
    }
    modelo.put("gestion", sGestion);
    modelo.put("periodo", sPeriodo);
	modelo.put("nro", sNro);
    ...
    return new ModelAndView("reportesAcademicos/imprimirCertificadoNotasNivel/ListarProgramasPlanes", modelo);
  }
}
