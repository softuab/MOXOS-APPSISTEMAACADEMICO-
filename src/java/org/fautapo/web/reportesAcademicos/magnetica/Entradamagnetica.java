 ...
 */
public class Entradamagnetica implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String sId_registro = request.getParameter("registro");
        if ("".equals(sId_registro) || sId_registro == null) {
            modelo.put("registro", "0");
        } else {
            modelo.put("registro", sId_registro);
        }
