...
public class BuscarEstudiantedocuEst implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if ("".equals(sId_estudiante) && ("".equals(sNombres)) && ("".equals(sCi))) {
      return new ModelAndView("reportesAcademicos/certificadoDocumentacionCompleta/Entrada", modelo);
    }
    ...
    if (!"".equals(sId_estudiante)) {
      ...
      return new ModelAndView("reportesAcademicos/certificadoDocumentacionCompleta/ListarEstudiantes", modelo);
    }
