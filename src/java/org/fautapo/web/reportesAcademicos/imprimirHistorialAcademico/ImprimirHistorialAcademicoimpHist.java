...
public class ImprimirHistorialAcademicoimpHist implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if ((!"".equals(sId_estudiante)) && (sId_estudiante!=null)) {
      ...
      if (datosEstudiante == null) {
        return new ModelAndView("reportesAcademicos/imprimirHistorialAcademico/Aviso","mensaje","El estudiante con R.U. : "+ sId_estudiante + "no esta registrado en el Programa : "+ datosPrograma.getPrograma() + ". Verifique.");
      }
      ...
      List lMaterias = this.mi.getListarPlanMateriasNotas2(datosEstudiante);
	...
	lMateriasNotas.add(i, datosNotas);
      ...
      List lFichaAcademica = this.mi.getEstListarFichaAcademicaConvalidada(datosEstudiante);
    ...
    if (datosInstitucionSede !=null) {
      ...
      return new ModelAndView("reportesAcademicos/imprimirHistorialAcademico/ImprimirHistorialAcademico", modelo);
    }
    ...
    return new ModelAndView("reportesAcademicos/imprimirHistorialAcademico/ListarDatosEstudiantes", modelo);
  }
}