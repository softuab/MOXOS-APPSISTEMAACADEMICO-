package org.fautapo.web.reportesAcademicos.nroEstMatriculadosSexoNacionalidad;
...
public class ListarMatriculadosSexNac implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    List lEstudiantes = this.mi.getListarNroEstMatriculadosSexosNacionalidades(datosEstudiante);
    ...
    return new ModelAndView("reportesAcademicos/nroEstMatriculadosSexoNacionalidad/ListarMatriculados", modelo);
  }
}