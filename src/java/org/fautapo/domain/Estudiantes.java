...
public class Estudiantes extends Personas {
    ...
    public String sede_desconcentrada;
    //public String tipo_evaluacion
    public String observacion;
    public String id_estado;
    public int id_estudiante_programa_sede;
    ...
    public int getId_estudiante_programa_sede() {
        return id_estudiante_programa_sede;
    }

    public void setId_estudiante_programa_sede(int id_estudiante_programa_sede) {
        this.id_estudiante_programa_sede = id_estudiante_programa_sede;
    }
