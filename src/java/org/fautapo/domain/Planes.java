...
public class Planes extends Menciones {
    ...
    public String getId_plan_ant() {
        return id_plan_ant;
    }

    public void setId_plan_ant(String id_plan_ant) {
        this.id_plan_ant = id_plan_ant;
    }
    ...
    public int getId_materia_ant() {
        return id_materia_ant;
    }

    public void setId_materia_ant(int id_materia_ant) {
        this.id_materia_ant = id_materia_ant;
    }
    ...
    public String getMaterias_anteriores() {
        return materias_anteriores;
    }

    public void setMaterias_anteriores(String materias_anteriores) {
        this.materias_anteriores = materias_anteriores;
    }

    public int getId_mtr_plan() {
        return id_mtr_plan;
    }

    public void setId_mtr_plan(int id_mtr_plan) {
        this.id_mtr_plan = id_mtr_plan;
    }
    ...
    public int getId_prg_plan() {
        return id_prg_plan;
    }

    public void setId_prg_plan(int id_prg_plan) {
        this.id_prg_plan = id_prg_plan;
    }
    ...
    public int getId_tipo_convalidacion() {
        return id_tipo_convalidacion;
    }

    public void setId_tipo_convalidacion(int id_tipo_convalidacion) {
        this.id_tipo_convalidacion = id_tipo_convalidacion;
    }

    public String getTipo_convalidacion() {
        return tipo_convalidacion;
    }

    public void setTipo_convalidacion(String tipo_convalidacion) {
        this.tipo_convalidacion = tipo_convalidacion;
    }

    public String getSigla_origen() {
        return sigla_origen;
    }

    public void setSigla_origen(String sigla_origen) {
        this.sigla_origen = sigla_origen;
    }

    public String getMateria_origen() {
        return materia_origen;
    }

    public void setMateria_origen(String materia_origen) {
        this.materia_origen = materia_origen;
    }
    ...
    public int getNota_origen() {
        return nota_origen;
    }

    public void setNota_origen(int nota_origen) {
        this.nota_origen = nota_origen;
    }
    ...
    public int getId_cnv_detalle() {
        return id_cnv_detalle;
    }

    public void setId_cnv_detalle(int id_cnv_detalle) {
        this.id_cnv_detalle = id_cnv_detalle;
    }
