...
public interface MiFacade {
    ...
    //Fin Administración de Reportes
    ...
    List<Programas> getUnvListarProgramas(Universidades universidad);
    ...
    List<Facultades> getUnvListarFacultades(Universidades universidad);
...
//Mostrar Ingreso UAB
    ...
    Perfiles getTrnBuscarTransaccionReciboSedePerfil(Perfiles perfil);
...
//  List getRepCajasGlobalGeneral(Perfiles perfil);
    ...
    Integer setRegistrarActualizarPersona(Personas persona);
    ...
    Estudiantes getEstBuscarEstudianteNombresSedePostgrado(Estudiantes estudiante);
    ...
    int getBuscarPrsDocumentacionCompletaDoc(Personas persona);
...
//FIN - METODOS ADICIONADOS POR LA UAP
    ...
    int getBuscar_ampliacion_calendario(Materias materia);

    List<Notas> getListaMayoresa80SinModalidad(int gestion, int periodo);

    List<Notas> getListaMayoresa80(int gestion, int periodo);

    List<Perfiles> getTrnBuscarTransaccionReciboSedePerfiles(Perfiles perfil);

    //ESTUDIANTES PROGRAMAS SEDE DESCONCENTRADOS
    List<ProgramasDesconcentrados> getListarProgramasDesconcentrados();

    Estudiantes getListarEstudiantesProgramasSede(Estudiantes estudiante);

    List getListarFclProgramasDescocentrado(int id_programa);

    int setRegistrarEstudiantes_programas_sede(Estudiantes estudiante);

    Estudiantes getDetalleEstudiantesProgramaSede(int id_estudiante);

    int setModificarProgramaDesconcentrado(Estudiantes estudiante);

    int setEliminarProgramaDesconcentrado(Estudiantes estudiante);

    List getVerProgramasFaseDesconcentrado(int id_estudiante);

    Estudiantes getMostraSedeDesconcentrada(int id_desconcentrado);

    int setActualizarIdDesconcentradoEstudiantes(Estudiantes estudiantes);

    Calendarios getDetalleCalendarioAcademico(Calendarios calendario);

    Estudiantes getDatosImpresionAfp(int id_estudiante);

    void RegistrarCsmbioAulaProgramacion(Estudiantes estudiantes);
}
